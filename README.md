...
* [RetroReversing](https://github.com/RetroReversing/retroReversing) ⭐ 699 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-13 - Curated list of retro game development and reverse-engineering resources, tools, and documentation, published as the RetroReversing.com website/wiki.
* [Galgame-Engine-Collect (galWiki)](https://github.com/2439905184/Galgame-Engine-Collect) ⭐ 665 | 🐛 9 | 📅 2026-06-21 - Extensive community knowledge base cataloging Japanese visual novel/galgame engines, their file formats, and associated extraction/translation tools.
...
* [awesome-gbdev](https://github.com/gbdev/awesome-gbdev) ⭐ 4,512 | 🐛 24 | 📅 2026-07-22 - Curated list of Game Boy development resources, including reverse-engineering tools, hardware/format documentation, disassemblers, and emulators.
...
* [Architecture of consoles](https://github.com/flipacholas/Architecture-of-consoles) ⭐ 1,106 | 🐛 27 | 📅 2026-09-12 - Series of technical articles on console hardware architecture, covering CPU, graphics, and file/memory layout across many platforms.
* [Pan Docs](https://github.com/gbdev/pandocs) ⭐ 784 | 🐛 145 | 🌐 Markdown | 📅 2026-09-14 - The single, most comprehensive technical reference to the Game Boy hardware available to the public, including cartridge header, memory bank controller, and save format documentation.
* [rom-properties](https://github.com/GerbilSoft/rom-properties) ⭐ 667 | 🐛 97 | 🌐 C++ | 📅 2026-09-23 - Shell extension for Windows and Linux that shows information about ROM and disc image files. Supports over 500 game and system file formats across dozens of consoles and handhelds.
...
* [assimp](https://github.com/assimp/assimp) ⭐ 13,217 | 🐛 558 | 🌐 C++ | 📅 2026-09-23 - The Open Asset Import Library, loading 40+ 3D model formats into one unified data structure. Widely used as the backend for game-format model converters and viewers. See also [Assimp.Net](https://github.com/StirlingLabs/Assimp.Net) ⭐ 49 | 🐛 4 | 🌐 C# | 📅 2023-10-18 below for a .NET wrapper.
* [vengi](https://github.com/vengi-voxel/vengi) ⭐ 1,413 | 🐛 130 | 🌐 C | 📅 2026-09-23 - Free, open-source, actively maintained voxel editor, thumbnailer, and command-line format converter.
...
* [binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,370 | 🐛 96 | 🌐 Rust | 📅 2026-08-11 - Firmware analysis tool for identifying and extracting embedded files and data. The Rust version (v3) provides significant speed and accuracy improvements over the original Python version.
* [AssetRipper](https://github.com/AssetRipper/AssetRipper) ⭐ 8,406 | 🐛 160 | 🌐 C# | 📅 2026-09-17 - GUI tool for extracting assets from Unity serialized files (*CAB-*\\*, *\\*.assets*, etc.) and asset bundles (*\\*.unity3d\*, *\\*.bundle\*, etc.) and converting them into the native Unity engine format.
* [Universal Extractor 2](https://github.com/Bioruebe/UniExtract2) ⭐ 4,433 | 🐛 123 | 🌐 AutoIt | 📅 2024-07-06 - Generic tool to extract files from any type of archive or installer, commonly used to unpack game installers (NSIS, InstallShield, Wise, and many more) before further asset processing.
* [GARbro](https://github.com/morkt/GARbro) ⭐ 3,302 | 🐛 275 | 🌐 C# | 📅 2024-07-08 - Visual novels resource browser and extractor supporting many formats. See also [crskycode's fork](https://github.com/crskycode/GARbro) ⭐ 789 | 🐛 8 | 🌐 C# | 📅 2026-09-19, which is actively maintained with additional format support; [nanami5270's fork](https://github.com/nanami5270/GARbro-Mod) ⭐ 140 | 🐛 2 | 🌐 C# | 📅 2026-09-19, another actively maintained fork with additional format/game support; and [UserUnknownFactor's GARbro2](https://github.com/UserUnknownFactor/GARbro2) ⭐ 60 | 🐛 4 | 🌐 C# | 📅 2026-02-23, which adds ImageMagick-based format support, sprite-sheet animation, and an in-app playback mode.
...
* [Greaseweazle](https://github.com/keirf/greaseweazle) ⭐ 1,408 | 🐛 85 | 🌐 Python | 📅 2026-06-16 - Hardware and tools for reading/writing floppy disks at the raw flux level, widely used for archiving copy-protected game floppies.
* [innoextract](https://github.com/dscharrer/innoextract) ⭐ 1,376 | 🐛 71 | 🌐 C++ | 📅 2025-02-06 - Extracts installers created by Inno Setup without running them, commonly used to unpack game installers before further asset processing.
* [extract-xiso](https://github.com/XboxDev/extract-xiso) ⭐ 1,166 | 🐛 40 | 🌐 C | 📅 2026-09-11 - Xbox ISO (XISO) creation, modification, and extraction utility for original Xbox disc images.
* [OmniDrive](https://github.com/RibShark/OmniDrive) ⭐ 1,155 | 🐛 26 | 🌐 Assembly | 📅 2026-07-18 - Firmware modification for MediaTek MT1959-based Hitachi-LG optical disc drives, enabling raw sector and lead-in/lead-out reading of CD/DVD/BD media including proprietary game discs.
...
* [DiskImageTool](https://github.com/Digitoxin1/DiskImageTool) ⭐ 118 | 🐛 7 | 🌐 Visual Basic .NET | 📅 2026-09-24 - Floppy disk image manager with built-in bitstream analysis, Greaseweazle support, and optional Kryoflux integration.
...
* [RIDE](https://github.com/tomas-nestorovic/RIDE) ⭐ 85 | 🐛 36 | 🌐 C++ | 📅 2026-09-23 - Windows tool for low-level raw floppy disk access and browsing legacy filesystems (ZX Spectrum, MS-DOS, and others) found on preserved game disks.
...
* [vgmtrans](https://github.com/vgmtrans/vgmtrans) ⭐ 1,272 | 🐛 51 | 🌐 C++ | 📅 2026-09-24 - Video Game Music Translator; converts proprietary game audio sequence/soundfont formats from many games/consoles into standard MIDI/DLS/SF2.
...
* [ymfm](https://github.com/aaronsgiles/ymfm) ⭐ 384 | 🐛 14 | 🌐 C++ | 📅 2026-07-27 - BSD-licensed emulation cores for Yamaha FM sound chips (OPM, OPN, OPL, and others) widely used across arcade and console game audio.
* [wwiser](https://github.com/bnnm/wwiser) ⭐ 369 | 🐛 3 | 🌐 Python | 📅 2026-09-23 - Wwise .bnk explorer and audio simulator. Python tool for parsing Wwise soundbank files, viewing HIRC audio scripting data, generating TXTP files for vgmstream playback, and dumping bank contents. Works with any game using Wwise audio middleware.
...
* [LunaTranslator](https://github.com/HIllya51/LunaTranslator) ⭐ 13,361 | 🐛 39 | 🌐 C++ | 📅 2026-09-23 - Full-featured visual novel translator application combining game text extraction with translation, OCR, and TTS.
...
* [Textractor](https://github.com/Artikash/Textractor) ⭐ 2,695 | 🐛 636 | 🌐 C++ | 📅 2024-03-15 - Highly extensible universal text hooker/extractor for video games and visual novels, widely used as the base for translation and OCR pipelines.
* [GalTransl](https://github.com/GalTransl/GalTransl) ⭐ 2,276 | 🐛 37 | 🌐 Python | 📅 2026-09-18 - Automated translation pipeline for Japanese visual novels using LLMs (GPT-4, Claude, DeepSeek, Sakura), consuming the script/text JSON exported by engine-specific extraction tools (e.g. [msg-tool](https://github.com/lifegpc/msg-tool) ⭐ 57 | 🐛 3 | 🌐 Rust | 📅 2026-09-06) and re-inserting translated text. See also [GalTransl\_DumpInjector](https://github.com/GalTransl/GalTransl_DumpInjector) ⭐ 24 | 🐛 1 | 🌐 Python | 📅 2025-12-20, a companion GUI front-end wrapping VNTextPatch, msg-tool, or custom regex to dump/inject game text across many VN engines.
...
* [ImHex](https://github.com/WerWolv/ImHex) ⭐ 54,889 | 🐛 399 | 🌐 C++ | 📅 2026-09-23 - Modern, open-source hex editor with pattern language for reverse engineering file formats (free).
...
* [fq](https://github.com/wader/fq) ⭐ 10,597 | 🐛 58 | 🌐 Go | 📅 2026-09-19 - "jq for binary formats" - command-line tool, language, and decoder collection for querying and inspecting binary and text formats, useful for ad-hoc exploration of unfamiliar game file formats.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 79,546 | 🐛 1,955 | 🌐 Java | 📅 2026-09-24 - NSA's software reverse engineering (SRE) framework. Includes disassembly, assembly, decompilation, graphing, and scripting. Extensible through Java and Python plugins.
* [Cutter](https://github.com/rizinorg/cutter) ⭐ 19,801 | 🐛 495 | 🌐 C++ | 📅 2026-09-11 - Free and open-source GUI-based reverse engineering platform powered by Rizin, for analyzing game binaries and file formats.
...
* [qiling](https://github.com/qilingframework/qiling) ⭐ 6,108 | 🐛 114 | 🌐 Python | 📅 2026-09-13 - Advanced binary emulation framework. Emulates multi-platforms (Windows, macOS, Linux, Android, BSD, UEFI, DOS) and multi-architectures (x86, ARM, MIPS, RISC-V, PowerPC). Supports PE, Mach-O, ELF formats with fine-grain instrumentation, cross-architecture debugging, and dynamic hot patching.
* [Steamless](https://github.com/atom0s/Steamless) ⭐ 5,048 | 🐛 26 | 🌐 C# | 📅 2024-03-30 - DRM remover for the SteamStub packer variants, unpacking Steam-protected game executables to enable further static/dynamic analysis of the underlying binary.
* [diaphora](https://github.com/joxeankoret/diaphora) ⭐ 4,403 | 🐛 35 | 🌐 Python | 📅 2026-09-04 - Advanced binary diffing tool (IDA/Binary Ninja/Ghidra) for comparing game binaries across versions/patches, widely used in game reverse engineering workflows.
* [iced](https://github.com/icedland/iced) ⭐ 3,569 | 🐛 61 | 🌐 Rust | 📅 2026-09-16 - Blazing fast and correct x86/x64 disassembler, assembler, decoder, and encoder. Available for Rust, .NET, Java, Python, and Lua. Useful for reverse engineering game binaries.
...
* [Senbei](https://github.com/Momoko-Ayase/Senbei) ⭐ 72 | 🐛 1 | 🌐 Rust | 📅 2026-09-20 - Static unpacker for binaries protected by CrackProof DRM (used by games such as Street Fighter V and Umamusume: Pretty Derby), enabling further static analysis of the underlying executable.
...
* [Recaf](https://github.com/Col-E/Recaf) ⭐ 7,394 | 🐛 65 | 🌐 Java | 📅 2026-09-15 - Modern Java bytecode editor. Easy-to-use interface for editing Java bytecode with decompiler integration, built-in compiler, bytecode assembler, and support for standard Java and Android applications.
* [JPEXS Free Flash Decompiler](https://github.com/jindrapetrik/jpexs-decompiler) ⭐ 5,886 | 🐛 2 | 🌐 Java | 📅 2026-09-20 - Free Flash (SWF) decompiler/editor for viewing and modifying ActionScript 1/2/3 bytecode, shapes, sprites, sounds, and other tags in SWF files, widely used for reverse-engineering Flash-based games.
* [hermes-dec](https://github.com/P1sec/hermes-dec) ⭐ 1,183 | 🐛 7 | 🌐 Python | 📅 2026-08-11 - Decompiler and disassembler for React Native Hermes bytecode (HBC).
...
* [RGBDS](https://github.com/gbdev/rgbds) ⭐ 1,654 | 🐛 95 | 🌐 C++ | 📅 2026-09-22 - Rednex Game Boy Development System: assembler/linker toolchain for Game Boy and Game Boy Color, including RGBGFX for converting images to/from the GB/GBC 2bpp tile format; the de facto standard toolchain for GB/GBC decompilation and disassembly projects (used by mgbdis and other decompilation projects listed above).
* [Spice86](https://github.com/OpenRakis/Spice86) ⭐ 659 | 🐛 22 | 🌐 C# | 📅 2026-09-23 - Reverse engineers and rewrites real-mode DOS programs by running the original executable and progressively replacing its functions with C# overrides, for recreating early DOS-era games from their binaries.
* [m2c](https://github.com/matt-kempster/m2c) ⭐ 641 | 🐛 62 | 🌐 Python | 📅 2026-09-16 - MIPS, ARM, PowerPC and SuperH decompiler.
...
* [objdiff](https://github.com/encounter/objdiff) ⭐ 554 | 🐛 98 | 🌐 Rust | 📅 2026-08-29 - Local diffing tool for decompilation projects.
...
* [asmlift](https://github.com/macabeus/asmlift) ⭐ 15 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-24 - MIPS, ARM and PowerPC decompiler.
...
* [PS2Recomp](https://github.com/ran-j/PS2Recomp) ⭐ 3,280 | 🐛 94 | 🌐 C++ | 📅 2026-09-20 - Static recompiler and runtime that converts PlayStation 2 ELF binaries into C++ to produce native PC ports.
* [skate3recomp](https://github.com/mchughalex/skate3recomp) ⭐ 1,354 | 🐛 81 | 🌐 C++ | 📅 2026-07-24 - Native recompilation of the Xbox 360 version of Skate 3 for Windows, Linux, and macOS, with a native Direct3D 12/Vulkan renderer replacing GPU emulation.
* [rexglue-sdk](https://github.com/rexglue/rexglue-sdk) ⭐ 903 | 🐛 31 | 🌐 C | 📅 2026-09-21 - Xbox 360 recompilation runtime and toolkit, used by static recompilation PC ports of Xbox 360 games.
* [RecompOne](https://github.com/BlackLabelHQ/RecompOne) ⭐ 529 | 🐛 2 | 🌐 C# | 📅 2026-09-12 - Static recompiler and runtime for PlayStation 1 (MIPS) game code, converting binaries into native executables.
...
* [snesrecomp](https://github.com/RetroPortingToolKit/snesrecomp) ⭐ 99 | 🐛 7 | 🌐 C | 📅 2026-09-23 - Static recompiler ecosystem for SNES games (part of the R.A.I.D. community), converting 65816 ROM code into portable native code.
* [ndsrecomp](https://github.com/RetroPortingToolKit/ndsrecomp) ⭐ 45 | 🐛 2 | 🌐 C++ | 📅 2026-09-14 - Early-stage static recompiler for Nintendo DS games.
...
* [segagenesisrecomp](https://github.com/mstan/segagenesisrecomp) ⭐ 33 | 🐛 1 | 🌐 C | 📅 2026-09-22 - Static recompiler for Sega Genesis/Mega Drive games.
* [gbarecomp](https://github.com/mstan/gbarecomp) ⭐ 32 | 🐛 2 | 🌐 C++ | 📅 2026-09-24 - General-purpose static recompiler for the Game Boy Advance.
...
* [PINCE](https://github.com/korcankaraokcu/PINCE) ⭐ 3,103 | 🐛 6 | 🌐 Python | 📅 2026-09-18 - GDB front-end/reverse engineering tool with a Cheat Engine-like interface for Linux.
* [ReClass.NET](https://github.com/ReClassNET/ReClass.NET) ⭐ 2,208 | 🐛 84 | 🌐 C# | 📅 2024-05-10 - Advanced memory class layout reverse engineering tool widely used for analyzing in-memory game data structures, helping translate runtime structures into file format definitions.
...
* [pcsx-redux](https://github.com/grumpycoders/pcsx-redux) ⭐ 997 | 🐛 162 | 🌐 C++ | 📅 2026-09-24 - Collection of tools, research, hardware design, and libraries for PlayStation 1 development and reverse engineering, built around a fork of the PCSX emulator with an integrated debugger, assembler, and GPU/memory analysis tooling.
...
* [Kaitai Struct](https://github.com/kaitai-io/kaitai_struct) ⭐ 4,684 | 🐛 530 | 🌐 Shell | 📅 2026-09-21 - Declarative language and code generator for binary data parsers in C++, C#, Go, Java, JavaScript, Python, Rust, and more; widely used for documenting and parsing game file formats.
...
* [Hexa.NET.ImGui](https://github.com/HexaEngine/Hexa.NET.ImGui) ⭐ 350 | 🐛 26 | 🌐 C# | 📅 2026-08-24 - .NET wrapper for ImGui, useful for creating tools with graphical interfaces.
...
* [noclip.website](https://github.com/magcius/noclip.website) ⭐ 4,271 | 🐛 92 | 🌐 TypeScript | 📅 2026-09-21 - In-browser 3D viewer for 100+ games across multiple platforms and studios.
...
* [MeltyTool](https://github.com/MeltyPlayer/MeltyTool) ⭐ 208 | 🐛 60 | 🌐 GLSL | 📅 2026-09-24 - Multitool for viewing/extracting assets from various N64/GCN/3DS/PC games.
...
* [XXMI Launcher](https://github.com/SpectrumQT/XXMI-Launcher) ⭐ 2,942 | 🐛 10 | 🌐 Python | 📅 2026-06-11 - Modding platform/launcher for a shared 3dmigoto-based model-importer ecosystem spanning multiple unrelated gacha titles, installing and hot-loading custom 3D character models as mods.
  * Components: [XXMI-Libs-Package](https://github.com/SpectrumQT/XXMI-Libs-Package) ⭐ 74 | 🐛 7 | 🌐 C++ | 📅 2026-09-19 (shared fork of [bo3b/3Dmigoto](https://github.com/bo3b/3Dmigoto) ⭐ 1,226 | 🐛 96 | 🌐 C++ | 📅 2026-09-06 packaged for the launcher), [XXMITools](https://github.com/leotorrez/XXMITools) ⭐ 144 | 🐛 52 | 🌐 Python | 📅 2026-09-22 (Blender add-on to import/export mod files for the supported games), [gui\_collect](https://github.com/Petrascyll/gui_collect) ⭐ 74 | 🐛 10 | 🌐 Python | 📅 2026-07-09 (GUI tool to collect/extract model data from 3dmigoto frame dumps for use with the importers).
  * Games: Genshin Impact (GIMI), Honkai: Star Rail (SRMI), Honkai Impact 3rd (HIMI), Zenless Zone Zero (ZZMI), Wuthering Waves (WWMI).
* [ScummVM](https://github.com/scummvm/scummvm) ⭐ 2,816 | 🐛 45 | 🌐 C++ | 📅 2026-09-24 - The canonical multi-engine interpreter that reimplements dozens of classic adventure/RPG engines, reading each game's original data files instead of emulating a CPU.
...
* [GameTracking](https://github.com/SteamTracking/GameTracking) ⭐ 306 | 🐛 0 | 🌐 Shell | 📅 2026-09-18 - Shared CI tooling behind the community's per-game Steam depot trackers, downloading and processing game update files across dozens of Valve titles (Dota 2, CS2, Half-Life, Portal, TF2, and more), including protobuf dumping and VPK content extraction.
...
* [VisualNoveltools](https://github.com/yy487/VisualNoveltools) ⭐ 31 | 🐛 0 | 🌐 Rust | 📅 2026-09-20 - Actively-maintained personal grab-bag of unpacking/repacking, image, and script-extraction tools organized one folder per game/engine, with completeness varying by title.
...
* [Zygisk-Il2CppDumper](https://github.com/Perfare/Zygisk-Il2CppDumper) ⭐ 3,303 | 🐛 174 | 🌐 C | 📅 2024-08-09 - Dumps IL2Cpp metadata from Unity games running on Android via Zygisk, enabling reverse-engineering of obfuscated game code and data.
* [Archipelago](https://github.com/ArchipelagoMW/Archipelago) ⭐ 1,684 | 🐛 610 | 🌐 Python | 📅 2026-09-22 - Multi-game item randomizer and server, generating patched ROMs/mods and syncing item checks across game worlds.
...
* [RomPatcher.js](https://github.com/marcrobledo/RomPatcher.js) ⭐ 1,207 | 🐛 19 | 🌐 JavaScript | 📅 2026-08-28 - JavaScript ROM patcher supporting IPS, BPS, UPS, APS, PPF, and other binary patch formats across many console ROM formats (used for Mario, Pokemon, Smash, and countless other ROM hacks).
...
* [apollo-ps4](https://github.com/bucanero/apollo-ps4) ⭐ 646 | 🐛 18 | 🌐 C | 📅 2026-09-10 - Apollo Save Tool for PS4, decrypting and editing save data for a wide range of games. See also [apollo-ps5](https://github.com/bucanero/apollo-ps5) ⭐ 33 | 🐛 1 | 📅 2026-05-22 for PS5 and [apollo-saves](https://github.com/bucanero/apollo-saves) ⭐ 169 | 🐛 13 | 🌐 C | 📅 2026-09-12, the online save-game database backing the Apollo Save Tool family (PS3/PS4/PS5).
* [apollo-ps3](https://github.com/bucanero/apollo-ps3) ⭐ 598 | 🐛 23 | 🌐 C | 📅 2026-09-10 - Apollo Save Tool for PS3, decrypting and editing save data for a wide range of games. See also the author's [save-decrypters](https://github.com/bucanero/save-decrypters) ⭐ 132 | 🐛 6 | 🌐 C | 📅 2026-09-11 collection above.
...
* [randovania](https://github.com/randovania/randovania) ⭐ 217 | 🐛 318 | 🌐 Python | 📅 2026-09-23 - A randomizer platform for a multitude of games, generating patched game files with randomized item/location placement.
...
* [BizHawk](https://github.com/TASEmulators/BizHawk) ⭐ 2,764 | 🐛 810 | 🌐 C# | 📅 2026-09-20 - Multi-system emulator built for tool-assisted speedrunning, with full rerecording, RAM search/watch, Lua scripting, and debugging tools across 20+ systems (NES, SNES, Genesis, Game Boy/GBA, N64, PS1, and more).
* [ld-decode](https://github.com/happycube/ld-decode) ⭐ 415 | 🐛 28 | 🌐 Jupyter Notebook | 📅 2026-09-13 - Software-defined LaserDisc RF decoder, used to digitize and preserve laserdisc arcade games for emulators such as hypseus-singe/DICE.
...
* [Hypdroid](https://github.com/rhakka303/Hypdroid) ⭐ 3 | 🐛 1 | 🌐 C | 📅 2026-09-23 - Standalone Android port of Hypseus Singe with a native gamepad-first game launcher.
...
* [libultraship](https://github.com/Kenix3/libultraship) ⭐ 350 | 🐛 168 | 🌐 C++ | 📅 2026-09-02 - Shared reimplementation of libultra (the Nintendo 64 SDK) and the O2R asset packaging system powering the Ship of Harkinian family of N64 decompilation PC ports.
...
* [WitchyBND](https://github.com/ividyon/WitchyBND) ⭐ 266 | 🐛 8 | 🌐 C# | 📅 2026-07-06 - Unpacker/repacker for FromSoftware game formats.
...
* [OpenE2140](https://github.com/OpenE2140/OpenE2140) ⭐ 72 | 🐛 99 | 🌐 C# | 📅 2026-09-20 - Playable remake of the RTS Earth 2140 built on the OpenRA engine (via the OpenRA Mod SDK), reading the original game's data files.
...
* [cinnamon](https://github.com/Project-Sunshine-Native/cinnamon) ⭐ 406 | 🐛 0 | 🌐 C | 📅 2026-09-14 - GameMaker runtime reimplementation ('Cinnamon') that loads original compiled GameMaker game data, in the tradition of phosphorvm and OpenGMK.
...
* [halflife](https://github.com/ValveSoftware/halflife) ⭐ 4,372 | 🐛 2,125 | 🌐 C++ | 📅 2024-10-02 - Valve's official Half-Life 1 SDK source release, containing the client/server game-logic DLL source that defines GoldSrc's original data formats.
* [noclip.website (Source Engine)](https://github.com/magcius/noclip.website/tree/main/src/SourceEngine) ⭐ 4,271 | 🐛 92 | 🌐 TypeScript | 📅 2026-09-21 - In-browser Source engine map viewer supporting Counter-Strike: Source, Day of Defeat: Source, Half-Life 2, Half-Life 2: Deathmatch, Half-Life 2: Lost Coast, Half-Life 2: Episode 1, Half-Life 2: Episode 2, Team Fortress 2, Portal, Portal 2, Counter-Strike: Global Offensive, Left 4 Dead 2, The Stanley Parable, Infra, Neo Tokyo, and Estranged: Act I.
* [noclip.website (GoldSrc)](https://github.com/magcius/noclip.website/tree/main/src/GoldSrc) ⭐ 4,271 | 🐛 92 | 🌐 TypeScript | 📅 2026-09-21 - In-browser GoldSrc map viewer supporting Half-Life, Counter-Strike, Team Fortress Classic, and Day of Defeat.
* [xash3d-fwgs](https://github.com/FWGS/xash3d-fwgs) ⭐ 2,800 | 🐛 427 | 🌐 C | 📅 2026-09-23 - Cross-platform reimplementation of the GoldSrc engine, loading original Half-Life BSP/WAD/MDL game data. Actively maintained; companion to hlsdk-portable.
* [ValveResourceFormat](https://github.com/ValveResourceFormat/ValveResourceFormat) ⭐ 2,450 | 🐛 65 | 🌐 C# | 📅 2026-09-24 - Source 2 Viewer is a powerful tool that allows you to browse VPK archives, view, extract, and decompile Source 2 assets, including maps, models, materials, textures, sounds, and more. Also includes C# library for reading and writing Valve Source engine resource files.
...
* [ReGameDLL\_CS](https://github.com/rehlds/ReGameDLL_CS) ⭐ 789 | 🐛 132 | 🌐 C++ | 📅 2026-09-17 - Enhanced, cross-platform server-side GameDLL reimplementation for Counter-Strike 1.6 and Condition Zero, a GoldSrc-format companion to ReHLDS.
...
* [hlsdk-portable](https://github.com/FWGS/hlsdk-portable) ⭐ 409 | 🐛 46 | 🌐 C++ | 📅 2026-09-23 - Cross-platform, actively maintained continuation of the Half-Life SDK for GoldSource and Xash3D, used to build original HL1 mod DLLs on modern OSes.
...
* [GameTracking (SteamDatabase)](https://github.com/SteamDatabase/GameTracking) ⭐ 306 | 🐛 0 | 🌐 Shell | 📅 2026-09-18 - Automated CI system that dumps Source 2 network protobufs, entity schemas, ConVars, and console commands from official Steam depot builds whenever a tracked game updates, useful for demo-parsing and protocol reverse engineering.
  * Per-game repos: [GameTracking-CS2](https://github.com/SteamTracking/GameTracking-CS2) ⭐ 956 | 🐛 0 | 🌐 Slang | 📅 2026-09-23, [GameTracking-Deadlock](https://github.com/SteamTracking/GameTracking-Deadlock) ⭐ 77 | 🐛 0 | 🌐 C++ | 📅 2026-09-18, [GameTracking-HalfLifeAlyx](https://github.com/SteamTracking/GameTracking-HalfLifeAlyx) ⭐ 24 | 🐛 0 | 🌐 CSS | 📅 2025-08-19.
...
* [sourcepp](https://github.com/craftablescience/sourcepp) ⭐ 140 | 🐛 13 | 🌐 C++ | 📅 2026-09-22 - C++20 library suite for parsing Source Engine file formats (VTF, MDL, VVD, VPK, BSP, etc.).
...
* [Hammer5Tools](https://github.com/dertwist/Hammer5Tools) ⭐ 62 | 🐛 0 | 🌐 Python | 📅 2026-09-23 - Suite of editors (SoundEvent, SmartProp, Hotkey, Loading) for Counter-Strike 2 / Source 2 Workshop Tools content creation, complementing Valve's official Hammer 5 editor.
...
* [MareTF](https://github.com/craftablescience/MareTF) ⭐ 135 | 🐛 17 | 🌐 C++ | 📅 2026-09-22 - Utility for creating, editing, and displaying VTF (Valve Texture Format) files. Supports all VTF versions used in Source Engine games (Half-Life 2, Portal, Counter-Strike, Team Fortress 2, etc.).
...
* [NARTools](https://github.com/SmilexGamer/NARTools) ⭐ 41 | 🐛 2 | 🌐 C# | 📅 2026-01-24 - Extractor, packager, and patcher for Nexon Archive (.nar) files, plus a model decryptor/encryptor for Counter-Strike Online's encrypted model files.
...
* [GameTracking-Dota2](https://github.com/SteamTracking/GameTracking-Dota2) ⭐ 762 | 🐛 0 | 🌐 C++ | 📅 2026-09-23 - Continuously-updated tracker of Dota 2's client-facing data extracted from each game update, including Source 2 protobuf network/GC message schemas (demo.proto, netmessages, GC messages) and dumped client schemas/module metadata, with full version history across patches.
* [dota2-mod-manager](https://github.com/TheFleece/dota2-mod-manager) ⭐ 37 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-24 - Mod manager for Dota 2, working with the game's original VPK addon format.
...
* [noclip.website (Unity)](https://github.com/magcius/noclip.website/tree/main/src/Common/Unity) ⭐ 4,271 | 🐛 92 | 🌐 TypeScript | 📅 2026-09-21 - From-scratch TypeScript/Rust reader for Unity SerializedFile and AssetBundle data. Reconstructs GameObject hierarchies, meshes, textures (including Crunch), and materials for in-browser rendering; drives the A Short Hike, Neon White, and Outer Wilds viewers.
...
* [UABEA (Unity Asset Bundle Extractor Avalonia)](https://github.com/nesrak1/UABEA) ⭐ 2,435 | 🐛 146 | 🌐 C# | 📅 2026-05-11 - C# UABE for newer versions of Unity. Cross-platform Unity asset bundle and serialized file editor/extractor built with Avalonia.
* [AssetStudio (aelurum fork)](https://github.com/aelurum/AssetStudio) ⭐ 2,084 | 🐛 53 | 🌐 C# | 📅 2025-10-15 - Actively maintained fork with UI optimization and enhancements.
...
* [UnityPy](https://github.com/K0lb3/UnityPy) ⭐ 1,457 | 🐛 21 | 🌐 Python | 📅 2026-08-01 - Python module that makes it possible to extract/unpack and edit Unity assets.
...
* [AnimeStudio](https://github.com/Escartem/AnimeStudio) ⭐ 1,200 | 🐛 23 | 🌐 C++ | 📅 2026-09-21 - Actively maintained "modded AssetStudio" fork with support for many encrypted Unity titles, including all HoYoverse games.
...
* [UABEANext](https://github.com/nesrak1/UABEANext) ⭐ 403 | 🐛 4 | 🌐 C# | 📅 2026-07-27 - Research and modding tool for SerializedFiles and Asset Bundles.
...
* [Cpp2IL](https://github.com/SamboyCoding/Cpp2IL) ⭐ 2,634 | 🐛 45 | 🌐 C# | 📅 2026-09-15 - Decompiler for Unity IL (Intermediate Language) code and assets.
...
* [Il2CppInspectorRedux](https://github.com/LukeFZ/Il2CppInspectorRedux) ⭐ 717 | 🐛 9 | 🌐 C# | 📅 2026-08-25 - Actively maintained continuation of Il2CppInspector, kept up to date with newer IL2CPP/Unity metadata versions.
...
* [BepInEx](https://github.com/BepInEx/BepInEx) ⭐ 8,705 | 🐛 389 | 🌐 C# | 📅 2026-09-20 - Widely-used, general-purpose plugin/patcher framework for Unity (Mono and IL2CPP) and .NET games, providing runtime hooking and mod-loading infrastructure used by many game-specific modding tools.
* [XUnity.AutoTranslator](https://github.com/bbepis/XUnity.AutoTranslator) ⭐ 3,425 | 🐛 448 | 🌐 C# | 📅 2026-09-20 - Universal translation framework for Unity games. Supports automatic text translation with various translator backends and IL2CPP support.
...
* [MonoMod](https://github.com/MonoMod/MonoMod) ⭐ 991 | 🐛 50 | 🌐 C# | 📅 2026-09-18 - Runtime IL patching, method detouring, and modding library/toolchain for .NET/Mono games, underlying many Unity and XNA/FNA game mods.
* [UnityDoorstop](https://github.com/NeighTools/UnityDoorstop) ⭐ 597 | 🐛 25 | 🌐 C | 📅 2026-09-22 - Cross-platform native bootstrapper that loads a .NET assembly into any Unity game at startup, used as the entry point by BepInEx and other Unity mod loaders.
...
* [SurrealEngine](https://github.com/dpjudas/SurrealEngine) ⭐ 1,105 | 🐛 15 | 🌐 C++ | 📅 2026-09-22 - Reimplementation of the Unreal Engine 1 engine that reads original Unreal/Unreal Tournament package/map assets to make the games playable on modern systems.

#### Asset Parsers & Libraries

* [UAssetGUI](https://github.com/atenfyr/UAssetGUI) ⭐ 1,060 | 🐛 18 | 🌐 C# | 📅 2026-08-31 - GUI tool for viewing and editing Unreal Engine UAsset files.
* [CUE4Parse](https://github.com/FabianFG/CUE4Parse) ⭐ 644 | 🐛 29 | 🌐 C# | 📅 2026-09-23 - C# Parser for UE archives.
* [UAssetAPI](https://github.com/atenfyr/UAssetAPI) ⭐ 498 | 🐛 6 | 🌐 C# | 📅 2026-08-31 - Low-level .NET library for reading and writing Unreal Engine game assets.
...
* [FModel](https://github.com/4sval/FModel) ⭐ 3,177 | 🐛 12 | 🌐 C# | 📅 2026-09-23 - Explorer and asset viewer for Unreal Engine archives, supporting UE4 and UE5.
...
* [repak](https://github.com/trumank/repak) ⭐ 571 | 🐛 13 | 🌐 Rust | 📅 2026-02-20 - Unreal Engine .pak file library and CLI in Rust.
...
* [UnrealModUnlocker-Public](https://github.com/IllusorySoftware/UnrealModUnlocker-Public) ⭐ 81 | 🐛 6 | 🌐 C | 📅 2023-10-16 - Unlocks loading of third-party/unpaked loose files for 90-95% of Unreal Engine 4 games, for testing and loading mods without repacking them into a `.pak`.
...
* [paksmith](https://github.com/r6e/paksmith) ⭐ 3 | 🐛 60 | 🌐 Rust | 📅 2026-09-23 - Cross-platform Rust tool for exploring and extracting Unreal Engine game assets from PAK archives, with glTF export support.
...
* [UEVR](https://github.com/praydog/UEVR) ⭐ 4,537 | 🐛 220 | 🌐 C++ | 📅 2026-08-30 - Universal Unreal Engine VR Mod. Powerful runtime reversing tool that provides an overlay for inspecting objects, classes, and properties in almost any UE4/5 game.
* [Dumper-7](https://github.com/Encryqed/Dumper-7) ⭐ 2,283 | 🐛 38 | 🌐 C | 📅 2026-09-15 - Unreal Engine SDK generator supporting all UE4 and UE5 versions, dumping engine classes/structs/offsets from a running game via DLL injection; the de facto standard modern UE SDK dumper and basis for several other tools already listed (e.g. UETools-GUI).
...
* [uesave](https://github.com/trumank/uesave) ⭐ 481 | 🐛 14 | 🌐 Rust | 📅 2026-04-23 - Rust library for reading and writing Unreal Engine save files.
...
* [Unreal-Mappings-Archive](https://github.com/TheNaeem/Unreal-Mappings-Archive) ⭐ 353 | 🐛 32 | 📅 2026-06-25 - Archive of Unreal Engine mapping files.
...
* [RE-UE4SS](https://github.com/UE4SS-RE/RE-UE4SS) ⭐ 2,927 | 🐛 273 | 🌐 C++ | 📅 2026-09-21 - Lua scripting system, SDK generator, blueprint mod loader, and live property editor for UE4/5 games. See also [UE4SSDotNet](https://github.com/WistfulHopes/UE4SSDotNet) ⭐ 2 | 🐛 1 | 🌐 C# | 📅 2025-07-26 for a UnrealCLR-based .NET runtime companion.
...
* [Dagor Engine](https://github.com/GaijinEntertainment/DagorEngine) ⭐ 2,968 | 🐛 76 | 🌐 C++ | 📅 2026-09-20 - Open-source release of the Dagor Engine (War Thunder, Enlisted) including parts of the toolchain.
...
* [bgt-decomp-tools](https://github.com/KamiKitsune420/bgt-decomp-tools) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-09-24 - Decompilation toolkit recovering source-level structure and assets from games built with BGT: bytecode unpacking, lifting to pseudo-source, disassembly, and sound-pack extraction.
...
* [mkxp](https://github.com/Ancurio/mkxp) ⭐ 589 | 🐛 45 | 🌐 C++ | 📅 2026-01-18 - Open-source reimplementation of the Ruby Game Scripting System (RGSS) used by RPG Maker XP, VX, and VX Ace, running games natively by reading their RGSSAD/RGSS2A/RGSS3A archives. See also the more actively maintained [mkxp-z fork](https://github.com/mkxp-z/mkxp-z) ⭐ 380 | 🐛 157 | 🌐 C++ | 📅 2026-06-30.
...
* [xsystem4](https://github.com/nunuhara/xsystem4) ⭐ 98 | 🐛 6 | 🌐 C | 📅 2026-09-22 - Cross-platform, open-source reimplementation of AliceSoft's System 4 engine, running original AliceSoft game data; companion compiler/decompiler/language server [sys4lang](https://github.com/kichikuou/sys4lang) ⭐ 5 | 🐛 0 | 🌐 OCaml | 📅 2026-09-24 (derived from nunuhara's sys4c). See also [xsystem4-android](https://github.com/kichikuou/xsystem4-android) ⭐ 42 | 🐛 2 | 🌐 Java | 📅 2026-09-22, an Android port.
...
* [rfvp](https://github.com/xmoezzz/rfvp) ⭐ 138 | 🐛 1 | 🌐 Rust | 📅 2026-09-24 - Non-official Rust reimplementation of the FVP engine and IDE, running games directly from their original `.hcb` script/asset files, with a debug HUD, custom-font support, and UTF-8/GBK translated-text encoding switching.
...
* [siglus\_rs](https://github.com/xmoezzz/siglus_rs) ⭐ 92 | 🐛 3 | 🌐 Rust | 📅 2026-09-24 - Unofficial Rust reimplementation and multi-platform port of SiglusEngine (Windows, Linux, macOS, iOS, Android, WebAssembly), for research purposes.
...
* [SiglusSceneScriptUtility](https://github.com/Jirehlov/SiglusSceneScriptUtility) ⭐ 22 | 🐛 0 | 🌐 Python | 📅 2026-09-24 - Extracts Siglus `Scene.pck` archives to editable `.ss` SceneScript files and recompiles them, aiming to reproduce the engine's original compilation as exactly as possible.
...
* [sena-rs](https://github.com/xmoezzz/sena-rs) ⭐ 14 | 🐛 0 | 🌐 Rust | 📅 2026-06-29 - Cross-platform Rust reimplementation of the SoftPAL engine, for the game Koikake.
...
* [ags2\_decomp](https://github.com/adm244/ags2_decomp) ⭐ 2 | 🐛 0 | 🌐 C | 📅 2026-09-07 - Matching decompilation of Adventure Game Studio 2.x runtime engine for reverse engineering and software preservation.
...
* [Ruffle](https://github.com/ruffle-rs/ruffle) ⭐ 18,568 | 🐛 5,641 | 🌐 Rust | 📅 2026-09-24 - Flash Player emulator written in Rust that parses and executes SWF files and ActionScript bytecode, used to preserve and play thousands of Flash-based web games.
...
* [gdsdecomp](https://github.com/GDRETools/gdsdecomp) ⭐ 4,223 | 🐛 40 | 🌐 C++ | 📅 2026-08-16 - Godot reverse engineering toolkit for game file format recovery, GDScript bytecode decompilation, and PCK archive extraction (Godot 2.x, 3.x, 4.x).
* [GodotPCKExplorer](https://github.com/DmitriySalnikov/GodotPCKExplorer) ⭐ 544 | 🐛 8 | 🌐 C# | 📅 2026-06-13 - GUI and CLI tool for exploring, extracting, creating, and merging Godot Engine `.pck` package files, with support for encrypted packs.
* [gdke](https://github.com/char-ptr/gdke) ⭐ 237 | 🐛 11 | 🌐 TypeScript | 📅 2024-09-05 - External GUI tool to extract the AES encryption key from Godot game binaries (3.x/4.x) without needing to run or patch the target executable. Builds on the same author's earlier [godot-key-extract](https://github.com/char-ptr/godot-key-extract) ⚠️ Archived, a CLI tool for the same technique.
...
* [noclip.website (Banjo)](https://github.com/magcius/noclip.website/blob/main/src/BanjoKazooie/f3dex.ts) ⭐ 4,271 | 🐛 92 | 🌐 TypeScript | 📅 2026-09-21 - F3DEX implementation for Banjo-Kazooie viewer.
* [RT64](https://github.com/rt64/rt64) ⭐ 1,599 | 🐛 94 | 🌐 C++ | 📅 2026-09-16 - N64 graphics renderer implementing the RDP/F3D microcode family with enhancements (widescreen, higher resolutions, ray tracing) for emulators and native ports.
* [fast64](https://github.com/Fast-64/fast64) ⭐ 535 | 🐛 83 | 🌐 Python | 📅 2026-09-22 - Blender plugin for exporting F3D display lists for N64 decompilation projects (Super Mario 64, Ocarina of Time).
* [MeltyTool (F3dzex2)](https://github.com/MeltyPlayer/MeltyTool/tree/main/FinModelUtility/Libraries/F3dzex2) ⭐ 208 | 🐛 60 | 🌐 GLSL | 📅 2026-09-24 - F3DZEX2 format support.
...
* [noclip.website (JSYSTEM)](https://github.com/magcius/noclip.website/tree/main/src/Common/JSYSTEM) ⭐ 4,271 | 🐛 92 | 🌐 TypeScript | 📅 2026-09-21 - In-browser viewer for JSYSTEM formats.
* [aurora](https://github.com/encounter/aurora) ⭐ 529 | 🐛 11 | 🌐 C++ | 📅 2026-09-24 - Source-level GameCube & Wii GX graphics compatibility layer, used by decompilation and static-recompilation projects to run original GC/Wii rendering code on modern backends (Dawn/WebGPU).
* [MeltyTool (JSystem)](https://github.com/MeltyPlayer/MeltyTool/tree/main/FinModelUtility/Libraries/JSystem) ⭐ 208 | 🐛 60 | 🌐 GLSL | 📅 2026-09-24 - JSystem format viewer/exporter.
...
* [M3G-Blender-Exporter](https://github.com/3dcinetv/M3G-Blender-Exporter) ⭐ 12 | 🐛 2 | 🌐 Python | 📅 2026-09-15 - Modern M3G (.m3g, JSR-184) exporter for Blender 3.6, implementing a byte-accurate full mobile 3D scene graph.
...
*[Murder Engine](https://github.com/isadorasophia/murder) ⭐ 3,330 | 🐛 16 | 🌐 C# | 📅 2026-09-23, a 2D game engine/framework used by several indie titles.*
...
* [MMD Tools](https://github.com/MMD-Blender/blender_mmd_tools) ⭐ 3,259 | 🐛 16 | 🌐 Python | 📅 2026-09-02 - Blender add-on for importing/exporting MikuMikuDance assets. Supports physics, bone constraints, and motion/pose data.
...
* [MikuMikuLibrary](https://github.com/blueskythlikesclouds/MikuMikuLibrary) ⭐ 246 | 🐛 11 | 🌐 C# | 📅 2026-04-22 - Library for working with MikuMikuDance formats.

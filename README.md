...
[Awesome](https://github.com/sindresorhus/awesome) ⭐ 498,355 | 🐛 105 | 📅 2026-08-18
...
* [awesome-gbdev](https://github.com/gbdev/awesome-gbdev) ⭐ 4,487 | 🐛 21 | 📅 2026-07-22 - Curated list of Game Boy development resources, including reverse-engineering tools, hardware/format documentation, disassemblers, and emulators.
* [Awesome PlayStation Vita](https://github.com/MuxaJlbl4/Awesome-PlayStation-Vita) ⭐ 1,798 | 🐛 0 | 🌐 Markdown | 📅 2026-08-03 - Comprehensive PS Vita resource list including reverse engineering tools, file format decompilers (.rco, .rcs), and RE utilities.
...
* [rom-properties](https://github.com/GerbilSoft/rom-properties) ⭐ 652 | 🐛 95 | 🌐 C++ | 📅 2026-08-20 - Shell extension for Windows and Linux that shows information about ROM and disc image files. Supports over 500 game and system file formats across dozens of consoles and handhelds.
...
* [kovidomi/game-reversing](https://github.com/kovidomi/game-reversing) ⭐ 1,677 | 🐛 4 | 📅 2023-04-05 - Beginner learning materials on reverse engineering video games.
...
* [assimp](https://github.com/assimp/assimp) ⭐ 13,148 | 🐛 535 | 🌐 C++ | 📅 2026-08-20 - The Open Asset Import Library, loading 40+ 3D model formats into one unified data structure. Widely used as the backend for game-format model converters and viewers. See also [Assimp.Net](https://github.com/StirlingLabs/Assimp.Net) ⭐ 49 | 🐛 4 | 🌐 C# | 📅 2023-10-18 below for a .NET wrapper.
...
* [binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,245 | 🐛 92 | 🌐 Rust | 📅 2026-08-11 - Firmware analysis tool for identifying and extracting embedded files and data. The Rust version (v3) provides significant speed and accuracy improvements over the original Python version.
* [AssetRipper](https://github.com/AssetRipper/AssetRipper) ⭐ 8,167 | 🐛 162 | 🌐 C# | 📅 2026-08-21 - GUI tool for extracting assets from Unity serialized files (*CAB-*\\*, *\\*.assets*, etc.) and asset bundles (*\\*.unity3d\*, *\\*.bundle\*, etc.) and converting them into the native Unity engine format.
* [Universal Extractor 2](https://github.com/Bioruebe/UniExtract2) ⭐ 4,406 | 🐛 124 | 🌐 AutoIt | 📅 2024-07-06 - Generic tool to extract files from any type of archive or installer, commonly used to unpack game installers (NSIS, InstallShield, Wise, and many more) before further asset processing.
...
* [extract-xiso](https://github.com/XboxDev/extract-xiso) ⭐ 1,130 | 🐛 40 | 🌐 C | 📅 2025-05-15 - Xbox ISO (XISO) creation, modification, and extraction utility for original Xbox disc images.
* [OmniDrive](https://github.com/RibShark/OmniDrive) ⭐ 1,079 | 🐛 19 | 🌐 Assembly | 📅 2026-07-18 - Firmware modification for MediaTek MT1959-based Hitachi-LG optical disc drives, enabling raw sector and lead-in/lead-out reading of CD/DVD/BD media including proprietary game discs.
...
* [redumper](https://github.com/superg/redumper) ⭐ 485 | 🐛 104 | 🌐 C++ | 📅 2026-08-14 - Low-level CD dumper utility for bit-perfect optical disc preservation, used by the Redump.org preservation community.
...
* [RIDE](https://github.com/tomas-nestorovic/RIDE) ⭐ 85 | 🐛 36 | 🌐 C++ | 📅 2026-08-20 - Windows tool for low-level raw floppy disk access and browsing legacy filesystems (ZX Spectrum, MS-DOS, and others) found on preserved game disks.
...
* [ImHex](https://github.com/WerWolv/ImHex) ⭐ 54,525 | 🐛 390 | 🌐 C++ | 📅 2026-08-21 - Modern, open-source hex editor with pattern language for reverse engineering file formats (free).

#### Scripts & Templates

* [hexyl](https://github.com/sharkdp/hexyl) ⭐ 10,262 | 🐛 34 | 🌐 Rust | 📅 2026-04-30 - Command-line hex viewer with colored output.
...
* [fq](https://github.com/wader/fq) ⭐ 10,568 | 🐛 57 | 🌐 Go | 📅 2026-08-20 - "jq for binary formats" - command-line tool, language, and decoder collection for querying and inspecting binary and text formats, useful for ad-hoc exploration of unfamiliar game file formats.
* [ImHex-Patterns](https://github.com/WerWolv/ImHex-Patterns) ⭐ 997 | 🐛 50 | 🌐 Rust | 📅 2026-08-20 - Binary format pattern database for ImHex hex editor, with game file format definitions and reverse-engineering templates.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 72,599 | 🐛 1,918 | 🌐 Java | 📅 2026-08-20 - NSA's software reverse engineering (SRE) framework. Includes disassembly, assembly, decompilation, graphing, and scripting. Extensible through Java and Python plugins.
* [Cutter](https://github.com/rizinorg/cutter) ⭐ 19,482 | 🐛 493 | 🌐 C++ | 📅 2026-08-13 - Free and open-source GUI-based reverse engineering platform powered by Rizin, for analyzing game binaries and file formats.
...
* [Steamless](https://github.com/atom0s/Steamless) ⭐ 4,973 | 🐛 25 | 🌐 C# | 📅 2024-03-30 - DRM remover for the SteamStub packer variants, unpacking Steam-protected game executables to enable further static/dynamic analysis of the underlying binary.
...
* [bytecode-viewer](https://github.com/Konloch/bytecode-viewer) ⭐ 15,604 | 🐛 103 | 🌐 Java | 📅 2026-07-17 - A Java 8+ Jar & Android APK reverse engineering suite. Includes multiple decompilers (FernFlower, Procyon, CFR), bytecode assemblers, and a keyword search feature.
...
* [Recaf](https://github.com/Col-E/Recaf) ⭐ 7,342 | 🐛 66 | 🌐 Java | 📅 2026-08-19 - Modern Java bytecode editor. Easy-to-use interface for editing Java bytecode with decompiler integration, built-in compiler, bytecode assembler, and support for standard Java and Android applications.
* [JPEXS Free Flash Decompiler](https://github.com/jindrapetrik/jpexs-decompiler) ⭐ 5,819 | 🐛 5 | 🌐 Java | 📅 2026-08-08 - Free Flash (SWF) decompiler/editor for viewing and modifying ActionScript 1/2/3 bytecode, shapes, sprites, sounds, and other tags in SWF files, widely used for reverse-engineering Flash-based games.
* [hermes-dec](https://github.com/P1sec/hermes-dec) ⭐ 1,151 | 🐛 7 | 🌐 Python | 📅 2026-08-11 - Decompiler and disassembler for React Native Hermes bytecode (HBC).
...
* [decomp.me](https://github.com/decompme/decomp.me) ⭐ 601 | 🐛 126 | 🌐 TypeScript | 📅 2026-08-20 - Collaborative decompilation and reverse engineering website, widely used to reverse game binaries function-by-function against a reference build.
...
* [transmuter](https://github.com/macabeus/transmuter) ⭐ 12 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-07 - Automatically mutates C, C++, or Pascal source code to match a target binary's assembly (or refine code quality while preserving the match), for matching decompilation projects.
...
* [PS2Recomp](https://github.com/ran-j/PS2Recomp) ⭐ 3,180 | 🐛 59 | 🌐 C++ | 📅 2026-08-19 - Static recompiler and runtime that converts PlayStation 2 ELF binaries into C++ to produce native PC ports.
* [rexglue-sdk](https://github.com/rexglue/rexglue-sdk) ⭐ 787 | 🐛 23 | 🌐 C | 📅 2026-08-20 - Xbox 360 recompilation runtime and toolkit, used by static recompilation PC ports of Xbox 360 games.
...
* [DolRecomp](https://github.com/ExpansionPak/DolRecomp) ⭐ 168 | 🐛 2 | 🌐 C | 📅 2026-08-21 - Static recompiler for GameCube, Wii, and experimental Wii U CPU code.
* [psxrecomp](https://github.com/mstan/psxrecomp) ⭐ 146 | 🐛 3 | 🌐 C++ | 📅 2026-08-21 - Static recompiler for PlayStation 1 (MIPS) game code.
...
* [ndsrecomp](https://github.com/mstan/ndsrecomp) ⭐ 29 | 🐛 3 | 🌐 C++ | 📅 2026-08-19 - Early-stage static recompiler for Nintendo DS games.
...
* [gbarecomp](https://github.com/mstan/gbarecomp) ⭐ 13 | 🐛 0 | 🌐 C++ | 📅 2026-08-15 - General-purpose static recompiler for the Game Boy Advance.
...
* [ghidra\_psx\_ldr](https://github.com/lab313ru/ghidra_psx_ldr) ⭐ 324 | 🐛 14 | 🌐 Java | 📅 2026-07-09 - PlayStation 1 binary loader for Ghidra.
...
* [Reloaded-II](https://github.com/Reloaded-Project/Reloaded-II) ⭐ 1,011 | 🐛 183 | 🌐 C# | 📅 2026-08-13 - Universal .NET Core powered modding framework for any native game (x86, x64). DLL injection based mod loader with mod management system, optional mod SDK, and extensive plugin support.
...
* [pcsx-redux](https://github.com/grumpycoders/pcsx-redux) ⭐ 982 | 🐛 151 | 🌐 C++ | 📅 2026-08-21 - Collection of tools, research, hardware design, and libraries for PlayStation 1 development and reverse engineering, built around a fork of the PCSX emulator with an integrated debugger, assembler, and GPU/memory analysis tooling.
...
* [Kaitai Struct](https://github.com/kaitai-io/kaitai_struct) ⭐ 4,657 | 🐛 524 | 🌐 Shell | 📅 2026-08-17 - Declarative language and code generator for binary data parsers in C++, C#, Go, Java, JavaScript, Python, Rust, and more; widely used for documenting and parsing game file formats.
...
* [MeltyTool](https://github.com/MeltyPlayer/MeltyTool) ⭐ 203 | 🐛 60 | 🌐 C# | 📅 2026-08-21 - Multitool for viewing/extracting assets from various N64/GCN/3DS/PC games.
...
* [ScummVM](https://github.com/scummvm/scummvm) ⭐ 2,784 | 🐛 48 | 🌐 C++ | 📅 2026-08-20 - The canonical multi-engine interpreter that reimplements dozens of classic adventure/RPG engines, reading each game's original data files instead of emulating a CPU.
...
* [Mixup](https://github.com/Fabulu/Mixup) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-21 - Hand-translates console game disassembly into readable, modifiable JavaScript (not emulation), verifying each translated routine frame-by-frame against the original ROM running in an emulator.
...
* [Archipelago](https://github.com/ArchipelagoMW/Archipelago) ⭐ 1,605 | 🐛 600 | 🌐 Python | 📅 2026-08-19 - Multi-game item randomizer and server, generating patched ROMs/mods and syncing item checks across game worlds.
...
* [RomPatcher.js](https://github.com/marcrobledo/RomPatcher.js) ⭐ 1,174 | 🐛 19 | 🌐 JavaScript | 📅 2026-07-11 - JavaScript ROM patcher supporting IPS, BPS, UPS, APS, PPF, and other binary patch formats across many console ROM formats (used for Mario, Pokemon, Smash, and countless other ROM hacks).
...
* [BizHawk](https://github.com/TASEmulators/BizHawk) ⭐ 2,728 | 🐛 794 | 🌐 C# | 📅 2026-08-18 - Multi-system emulator built for tool-assisted speedrunning, with full rerecording, RAM search/watch, Lua scripting, and debugging tools across 20+ systems (NES, SNES, Genesis, Game Boy/GBA, N64, PS1, and more).
* [ld-decode](https://github.com/happycube/ld-decode) ⭐ 410 | 🐛 25 | 🌐 Jupyter Notebook | 📅 2026-08-16 - Software-defined LaserDisc RF decoder, used to digitize and preserve laserdisc arcade games for emulators such as hypseus-singe/DICE.
* [hypseus-singe](https://github.com/DirtBagXon/hypseus-singe) ⭐ 234 | 🐛 1 | 🌐 C | 📅 2026-08-08 - SDL3-based continuation of Daphne/Singe, emulating laserdisc arcade games by reading their original laserdisc video/ROM data. Companion [hypseus\_singe\_data](https://github.com/DirtBagXon/hypseus_singe_data) ⭐ 49 | 🐛 0 | 📅 2026-08-16 package provides the LUA game-definition scripts for dozens of supported titles (Dragon's Lair, Space Ace, Cliff Hanger, M.A.C.H. 3, and more).
...
* [dice-libretro](https://github.com/mittonk/dice-libretro) ⭐ 9 | 🐛 1 | 🌐 C | 📅 2026-08-14 - Libretro/RetroArch port of DICE (Discrete Integrated Circuit Emulator), emulating early arcade systems built from discrete logic components with no CPU.
...
* [Hypdroid](https://github.com/rhakka303/Hypdroid) ⭐ 2 | 🐛 1 | 🌐 C | 📅 2026-08-21 - Standalone Android port of Hypseus Singe with a native gamepad-first game launcher.
...
* [savegame-editors](https://github.com/marcrobledo/savegame-editors) ⭐ 1,306 | 🐛 136 | 🌐 JavaScript | 📅 2026-07-21 - Compilation of browser-based (HTML5) console savegame editors.
...
* [Smithbox](https://github.com/vawser/Smithbox) ⭐ 695 | 🐛 6 | 🌐 C# | 📅 2026-08-21 - Comprehensive modding toolkit for modern FromSoftware games.
...
* [UndertaleModTool](https://github.com/UnderminersTeam/UndertaleModTool) ⭐ 2,004 | 🐛 320 | 🌐 C# | 📅 2026-08-19 - Tool for modding/decompiling GameMaker games.
...
* [xash3d-fwgs](https://github.com/FWGS/xash3d-fwgs) ⭐ 2,726 | 🐛 446 | 🌐 C | 📅 2026-08-18 - Cross-platform reimplementation of the GoldSrc engine, loading original Half-Life BSP/WAD/MDL game data. Actively maintained; companion to hlsdk-portable.
* [ValveResourceFormat](https://github.com/ValveResourceFormat/ValveResourceFormat) ⭐ 2,379 | 🐛 71 | 🌐 C# | 📅 2026-08-21 - Source 2 Viewer is a powerful tool that allows you to browse VPK archives, view, extract, and decompile Source 2 assets, including maps, models, materials, textures, sounds, and more. Also includes C# library for reading and writing Valve Source engine resource files.
* [source-engine](https://github.com/nillerusr/source-engine) ⭐ 2,209 | 🐛 131 | 🌐 C++ | 📅 2025-11-25 - Modified Source engine (2017) developed by Valve and leaked in 2020. Not for commercial purposes.
...
* [ReGameDLL\_CS](https://github.com/rehlds/ReGameDLL_CS) ⭐ 774 | 🐛 285 | 🌐 C++ | 📅 2026-07-09 - Enhanced, cross-platform server-side GameDLL reimplementation for Counter-Strike 1.6 and Condition Zero, a GoldSrc-format companion to ReHLDS.
...
* [halflife-updated](https://github.com/twhl-community/halflife-updated) ⭐ 483 | 🐛 22 | 🌐 C++ | 📅 2026-08-02 - TWHL community-maintained, modernized fork of Valve's Half-Life 1 SDK with bug fixes and cross-platform build support.
...
* [sourcepp](https://github.com/craftablescience/sourcepp) ⭐ 137 | 🐛 14 | 🌐 C++ | 📅 2026-08-06 - C++20 library suite for parsing Source Engine file formats (VTF, MDL, VVD, VPK, BSP, etc.).
...
* [WifeRadiant](https://github.com/erysdren/WifeRadiant) ⭐ 116 | 🐛 7 | 🌐 C++ | 📅 2026-08-18 - Open-source, cross-platform level editor for idTech, Source Engine, and GoldSrc based games; modern fork of NetRadiant.
...
* [MareTF](https://github.com/craftablescience/MareTF) ⭐ 126 | 🐛 16 | 🌐 C++ | 📅 2026-07-10 - Utility for creating, editing, and displaying VTF (Valve Texture Format) files. Supports all VTF versions used in Source Engine games (Half-Life 2, Portal, Counter-Strike, Team Fortress 2, etc.).
...
* [VPKEdit](https://github.com/craftablescience/VPKEdit) ⭐ 730 | 🐛 50 | 🌐 C++ | 📅 2026-08-10 - Cross-platform GUI and CLI tool for creating, reading, and writing many pack file formats used across Source, GoldSrc, and Quake-family games.
...
* [GameTracking-Dota2](https://github.com/SteamTracking/GameTracking-Dota2) ⭐ 755 | 🐛 0 | 🌐 C++ | 📅 2026-08-19 - Continuously-updated tracker of Dota 2's client-facing data extracted from each game update, including Source 2 protobuf network/GC message schemas (demo.proto, netmessages, GC messages) and dumped client schemas/module metadata, with full version history across patches.
* [dota2-mod-manager](https://github.com/TheFleece/dota2-mod-manager) ⭐ 12 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-21 - Mod manager for Dota 2, working with the game's original VPK addon format.
...
* [UABEA (Unity Asset Bundle Extractor Avalonia)](https://github.com/nesrak1/UABEA) ⭐ 2,394 | 🐛 145 | 🌐 C# | 📅 2026-05-11 - C# UABE for newer versions of Unity. Cross-platform Unity asset bundle and serialized file editor/extractor built with Avalonia.
* [AssetStudio (aelurum fork)](https://github.com/aelurum/AssetStudio) ⭐ 2,021 | 🐛 51 | 🌐 C# | 📅 2025-10-15 - Actively maintained fork with UI optimization and enhancements.
...
* [AssetsTools.NET](https://github.com/nesrak1/AssetsTools.NET) ⭐ 678 | 🐛 36 | 🌐 C# | 📅 2026-08-02 - Read and write Unity assets/bundle files, based on UABE.
...
* [Il2CppDumper](https://github.com/Perfare/Il2CppDumper) ⭐ 9,318 | 🐛 156 | 🌐 C# | 📅 2024-08-18 - Unity IL2CPP reverse engineer tool for extracting IL2CPP metadata and converting IL2CPP binaries.
* [Il2CppInspector](https://github.com/djkaty/Il2CppInspector) ⭐ 3,028 | 🐛 66 | 🌐 C | 📅 2022-05-13 - Powerful automated tool for reverse engineering Unity IL2CPP binaries. Outputs IL2CPP type definitions, metadata and method pointers as C# stub code, creates .NET assembly shim DLLs, and generates C++ scaffolding for all types, methods, function pointers and API functions.
* [Cpp2IL](https://github.com/SamboyCoding/Cpp2IL) ⭐ 2,582 | 🐛 44 | 🌐 C# | 📅 2026-08-19 - Decompiler for Unity IL (Intermediate Language) code and assets.
...
* [Zygisk-Il2CppFucker](https://github.com/Darlenepurpleblack444/Zygisk-Il2CppFucker) ⭐ 2 | 🐛 0 | 🌐 C | 📅 2026-08-19 - Zygisk module for reverse engineering IL2CPP binaries in Android Unity games at runtime.
...
* [XUnity.AutoTranslator](https://github.com/bbepis/XUnity.AutoTranslator) ⭐ 3,347 | 🐛 447 | 🌐 C# | 📅 2026-07-24 - Universal translation framework for Unity games. Supports automatic text translation with various translator backends and IL2CPP support.
...
* [SurrealEngine](https://github.com/dpjudas/SurrealEngine) ⭐ 1,092 | 🐛 14 | 🌐 C++ | 📅 2026-08-20 - Reimplementation of the Unreal Engine 1 engine that reads original Unreal/Unreal Tournament package/map assets to make the games playable on modern systems.

#### Asset Parsers & Libraries

* [UAssetGUI](https://github.com/atenfyr/UAssetGUI) ⭐ 1,034 | 🐛 15 | 🌐 C# | 📅 2026-08-14 - GUI tool for viewing and editing Unreal Engine UAsset files.
* [CUE4Parse](https://github.com/FabianFG/CUE4Parse) ⭐ 615 | 🐛 27 | 🌐 C# | 📅 2026-08-20 - C# Parser for UE archives.
* [UAssetAPI](https://github.com/atenfyr/UAssetAPI) ⭐ 481 | 🐛 4 | 🌐 C# | 📅 2026-08-20 - Low-level .NET library for reading and writing Unreal Engine game assets.
* [Unreal-Library](https://github.com/EliotVU/Unreal-Library) ⭐ 473 | 🐛 4 | 🌐 C# | 📅 2026-08-15 - Library for reading and writing Unreal Engine file formats.
* [JsonAsAsset](https://github.com/JsonAsAsset/JsonAsAsset) ⭐ 361 | 🐛 1 | 🌐 C++ | 📅 2026-08-20 - Unreal Engine plugin to import assets from JSON data exported by FModel.
* [JsonAsAsset](https://github.com/JsonAsAsset/Reflection) ⭐ 361 | 🐛 1 | 🌐 C++ | 📅 2026-08-20 - Unreal Engine asset reconstruction toolkit; an in-editor plugin that rebuilds engine assets (materials, data assets, curves, and more) from JSON dumps produced by CUE4Parse/FModel.
...
* [Core](https://github.com/JsonAsAsset/Core) ⭐ 26 | 🐛 0 | 🌐 C# | 📅 2026-08-20 - Extension of JsonAsAsset's Reflection above that fetches referenced Unreal Engine assets automatically, hands-free.
...
* [FModel](https://github.com/4sval/FModel) ⭐ 3,059 | 🐛 13 | 🌐 C# | 📅 2026-08-15 - Explorer and asset viewer for Unreal Engine archives, supporting UE4 and UE5.
...
* [UEVR](https://github.com/praydog/UEVR) ⭐ 4,458 | 🐛 209 | 🌐 C++ | 📅 2026-07-26 - Universal Unreal Engine VR Mod. Powerful runtime reversing tool that provides an overlay for inspecting objects, classes, and properties in almost any UE4/5 game.
* [Dumper-7](https://github.com/Encryqed/Dumper-7) ⭐ 2,182 | 🐛 37 | 🌐 C | 📅 2026-08-06 - Unreal Engine SDK generator supporting all UE4 and UE5 versions, dumping engine classes/structs/offsets from a running game via DLL injection; the de facto standard modern UE SDK dumper and basis for several other tools already listed (e.g. UETools-GUI).
...
* [Unreal-Mappings-Archive](https://github.com/TheNaeem/Unreal-Mappings-Archive) ⭐ 340 | 🐛 26 | 📅 2026-06-25 - Archive of Unreal Engine mapping files.
* [UEAESKeyFinder](https://github.com/EZFNDEV/UEAESKeyFinder) ⭐ 251 | 🐛 20 | 🌐 C# | 📅 2022-01-11 - Finds the AES decryption key of practically any Unreal Engine game.
...
* [RE-UE4SS](https://github.com/UE4SS-RE/RE-UE4SS) ⭐ 2,813 | 🐛 258 | 🌐 C++ | 📅 2026-08-19 - Lua scripting system, SDK generator, blueprint mod loader, and live property editor for UE4/5 games.
...
* [UE\_Modding](https://github.com/Dmgvol/UE_Modding) ⭐ 579 | 🐛 0 | 📅 2026-06-10 - Comprehensive collection of guides and resources for modding Unreal Engine 4 and 5 games.
...
* [cobra-tools](https://github.com/OpenNaja/cobra-tools) ⭐ 152 | 🐛 14 | 🌐 Python | 📅 2026-08-20 - Suite of GUI tools for extracting and modifying OVL and OVS archives, as well as editing associated file formats and models for the Cobra Engine (Frontier Developments).
...
* [unrpyc](https://github.com/CensoredUsername/unrpyc) ⭐ 1,229 | 🐛 11 | 🌐 Ren'Py | 📅 2026-02-24 - Decompiler that reconstructs readable Ren'Py .rpy script source from compiled .rpyc bytecode files.
...
* [Gargoyle](https://github.com/garglk/garglk) ⭐ 425 | 🐛 66 | 🌐 C++ | 📅 2026-08-19 - Cross-platform multi-format interactive-fiction player supporting Z-machine, Glulx, TADS, Hugo, and other IF virtual machine formats.
...
* [Lectrote](https://github.com/erkyrath/lectrote) ⭐ 269 | 🐛 49 | 🌐 JavaScript | 📅 2025-10-04 - Electron-based interactive fiction interpreter, playing Z-code and Glulx games.
...
* [AGSUnpacker](https://github.com/adm244/AGSUnpacker) ⭐ 41 | 🐛 2 | 🌐 C# | 📅 2026-08-10 - Unpacker/packer for compiled Adventure Game Studio (AGS) 2.x–3.x game resources.
...
* [Sierra softlock analyzer](https://github.com/katiahayati/lucasartsifier) ⭐ 41 | 🐛 0 | 🌐 Python | 📅 2026-08-21 - Static analysis tool that decompiles a Sierra SCI game and abstract-interprets the decompiled scripts into a graph of guarded room transitions, used to find softlocks in 30-year-old adventure games.
...
* [Ruffle](https://github.com/ruffle-rs/ruffle) ⭐ 18,436 | 🐛 5,631 | 🌐 Rust | 📅 2026-08-21 - Flash Player emulator written in Rust that parses and executes SWF files and ActionScript bytecode, used to preserve and play thousands of Flash-based web games.
...
* [gdsdecomp](https://github.com/GDRETools/gdsdecomp) ⭐ 4,085 | 🐛 38 | 🌐 C++ | 📅 2026-08-16 - Godot reverse engineering toolkit for game file format recovery, GDScript bytecode decompilation, and PCK archive extraction (Godot 2.x, 3.x, 4.x).
...
* [RT64](https://github.com/rt64/rt64) ⭐ 1,576 | 🐛 88 | 🌐 C++ | 📅 2026-08-06 - N64 graphics renderer implementing the RDP/F3D microcode family with enhancements (widescreen, higher resolutions, ray tracing) for emulators and native ports.
* [fast64](https://github.com/Fast-64/fast64) ⭐ 526 | 🐛 81 | 🌐 Python | 📅 2026-08-20 - Blender plugin for exporting F3D display lists for N64 decompilation projects (Super Mario 64, Ocarina of Time).
* [MeltyTool (F3dzex2)](https://github.com/MeltyPlayer/MeltyTool/tree/main/FinModelUtility/Libraries/F3dzex2) ⭐ 203 | 🐛 60 | 🌐 C# | 📅 2026-08-21 - F3DZEX2 format support.
...
* [aurora](https://github.com/encounter/aurora) ⭐ 458 | 🐛 11 | 🌐 C++ | 📅 2026-08-20 - Source-level GameCube & Wii GX graphics compatibility layer, used by decompilation and static-recompilation projects to run original GC/Wii rendering code on modern backends (Dawn/WebGPU).
* [MeltyTool (JSystem)](https://github.com/MeltyPlayer/MeltyTool/tree/main/FinModelUtility/Libraries/JSystem) ⭐ 203 | 🐛 60 | 🌐 C# | 📅 2026-08-21 - JSystem format viewer/exporter.
...
*[Murder Engine](https://github.com/isadorasophia/murder) ⭐ 3,311 | 🐛 16 | 🌐 C# | 📅 2026-08-20, a 2D game engine/framework used by several indie titles.*
...
* [FNA](https://github.com/FNA-XNA/FNA) ⭐ 3,032 | 🐛 57 | 🌐 C# | 📅 2026-08-21 - Accuracy-focused reimplementation of the XNA4 framework for modern platforms, reading original .xnb content files; widely used to port XNA-based games (Terraria, Bastion, Fez, and others).
...
* [nsz](https://github.com/nicoboss/nsz) ⭐ 2,344 | 🐛 36 | 🌐 Python | 📅 2026-08-13 - Homebrew-compatible NSP/XCI compressor and decompressor for Nintendo Switch game dumps.
...
* [hactool](https://github.com/SciresM/hactool) ⭐ 1,178 | 🐛 29 | 🌐 C | 📅 2023-12-04 - Tool to view information about, decrypt, and extract Nintendo Switch file formats including NCA, XCI, PFS0, HFS0, RomFS, ExeFS, save data, and more.
...
* [NxFileViewer](https://github.com/Myster-Tee/NxFileViewer) ⭐ 341 | 🐛 13 | 🌐 C# | 📅 2025-10-08 - GUI viewer for the contents of Nintendo Switch container files.
...
* [Checkpoint](https://github.com/BernardoGiordano/Checkpoint) ⭐ 3,052 | 🐛 30 | 🌐 C++ | 📅 2026-08-20 - Fast and simple homebrew save management framework for 3DS and Switch.
...
* [Kaitai-Files](https://github.com/RiiConnect24/Kaitai-Files) ⭐ 18 | 🐛 0 | 🌐 Kaitai Struct | 📅 2024-02-03 - Kaitai Struct definitions documenting proprietary Wii file formats, including WiiConnect24 channel data (e.g. the Forecast Channel), compilable into parsers for any Kaitai-supported language.
...
* [Dolphin](https://github.com/dolphin-emu/dolphin) ⭐ 15,416 | 🐛 458 | 🌐 C++ | 📅 2026-08-21 - GameCube and Wii emulator that parses and implements support for GameCube/Wii disc and asset file formats.
...
* [ipl3checksum](https://github.com/Decompollaborate/ipl3checksum) ⭐ 9 | 🐛 0 | 🌐 Rust | 📅 2026-01-17 - Python and Rust library to calculate the IPL3 (boot code) checksum for N64 ROMs, used to validate/patch ROMs in decompilation and recompilation workflows.
...
* [snes-sdd1-python](https://github.com/gufranco/snes-sdd1-python) ⭐ 0 | 🐛 2 | 🌐 Python | 📅 2026-08-20 - Python reimplementation of the SNES S-DD1 compression coprocessor (used by Star Ocean and Street Fighter Alpha 2), checked against the snes9x reference decoder across 4,000 golden test vectors.
...
* [nploader](https://github.com/codestation/nploader) ⭐ 18 | 🐛 1 | 🌐 C | 📅 2024-09-30 - PSP plugin for directly reading and loading DLC content in decrypted EDAT/PGD/SPRX form.
...
* [SteamKit](https://github.com/SteamRE/SteamKit) ⭐ 3,163 | 🐛 37 | 🌐 C# | 📅 2026-08-01 - .NET library implementing Valve's Steam network protocol, providing programmatic access to Steam services (CDN/depot downloads, game coordinator messages, etc.).
...
* [vcmi](https://github.com/vcmi/vcmi) ⭐ 5,792 | 🐛 686 | 🌐 C++ | 📅 2026-08-20 - Open-source reimplementation of the Heroes of Might and Magic III engine, loading and reading the original game's data files (H3sprite.lod, Heroes3.exe resources, maps, campaigns).
...
* [elite-source-code-commodore-64](https://github.com/markmoxon/elite-source-code-commodore-64) ⭐ 463 | 🐛 0 | 🌐 Assembly | 📅 2026-08-11 - Fully documented, annotated source code disassembly for the Commodore 64 version of Elite.
...
* [Greyhound](https://github.com/Scobalula/Greyhound) ⭐ 468 | 🐛 4 | 🌐 C++ | 📅 2024-07-28 - Asset extractor for several Call of Duty titles (Black Ops 3/4, WWII, Infinite Warfare, Modern Warfare 2019/II).
...
* [gta-v-data-dumps](https://github.com/DurtyFree/gta-v-data-dumps) ⭐ 1,022 | 🐛 18 | 📅 2026-06-09 - Collection of GTA V data dumps (vehicles, weapons, peds, natives, etc.) generated from RAGE-format research; reference for modding and scripting.
...
* [MeltyTool](https://github.com/MeltyPlayer/MeltyTool/tree/main/FinModelUtility/Libraries/AngelStudios) ⭐ 203 | 🐛 60 | 🌐 C# | 📅 2026-08-21 - Multitool for viewing/extracting assets from various N64/GCN/3DS/PC games en-masse.
...
* [filediver](https://github.com/xypwn/filediver) ⭐ 117 | 🐛 10 | 🌐 Go | 📅 2026-08-19 - Extractor for Helldivers 2. Supports extracting models, audio, video, and textures.
* [Hellextractor](https://github.com/Xaymar/Hellextractor) ⚠️ Archived - Another Helldivers 2 extractor (archived, recommended to use [filediver](https://github.com/xypwn/filediver) ⭐ 117 | 🐛 10 | 🌐 Go | 📅 2026-08-19 instead).
...
* [my-assets-studio](https://github.com/WhiteLeer/my-assets-studio) ⭐ 11 | 🐛 0 | 🌐 C | 📅 2026-08-12 - Asset extraction/editing studio for Atlus games' archive and texture formats.
...
* [PyNifly](https://github.com/BadDogSkyrim/PyNifly) ⭐ 301 | 🐛 117 | 🌐 Python | 📅 2026-08-20 - Export/import tools between Blender and the NIF format, using Bodyslide/Outfit Studio's Nifly layer. Supports Skyrim LE, Skyrim SE, Fallout 4, Fallout New Vegas, Fallout 76, and Fallout 3.
...
* [OpenMW](https://github.com/OpenMW/openmw) ⭐ 6,517 | 🐛 0 | 🌐 C++ | 📅 2026-08-21 - Open-source unofficial engine reimplementation of Morrowind that reads and parses the original game's ESM/ESP plugin files and BSA archives to run without Bethesda's original engine.
...
* [daggerfall-unity](https://github.com/Interkarma/daggerfall-unity) ⭐ 3,470 | 🐛 76 | 🌐 C# | 📅 2026-06-30 - Open-source recreation of The Elder Scrolls II: Daggerfall in the Unity engine, reverse-engineering and loading the original Daggerfall (DOS) game data and formats.
* [OpenTESArena](https://github.com/afritz1/OpenTESArena) ⭐ 1,401 | 🐛 20 | 🌐 C++ | 📅 2026-08-13 - Open-source reimplementation of The Elder Scrolls: Arena's engine that reads the original game's data files (CFA, IMG, SET, and other Arena-specific formats).
...
* [Creation Kit Platform Extended](https://github.com/Perchik71/Creation-Kit-Platform-Extended) ⭐ 133 | 🐛 33 | 🌐 C++ | 📅 2026-07-29 - Collection of reverse-engineered fixes, enhancements, and extended modding features for Bethesda's Creation Kit.
...
* [KotOR.js](https://github.com/KobaltBlu/KotOR.js) ⭐ 140 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-21 - TypeScript/Electron remake of the Odyssey Game Engine that powered Star Wars: Knights of the Old Republic and KotOR II: The Sith Lords, interfacing directly with an installed copy's game files (no game content is distributed). Includes an early modding suite, KotOR Forge.
...
* [WoWee](https://github.com/Kelsidavis/WoWee) ⭐ 664 | 🐛 5 | 🌐 C++ | 📅 2026-08-21 - Native C++ World of Warcraft client reimplementation with a custom Vulkan renderer, parsing original WMO/M2 model and terrain data.
...
* [wow.export](https://github.com/Kruithne/wow.export) ⭐ 522 | 🐛 75 | 🌐 JavaScript | 📅 2026-06-22 - Export toolkit for World of Warcraft models and textures.
...
* [wow-listfile](https://github.com/wowdev/wow-listfile) ⭐ 203 | 🐛 1 | 🌐 C# | 📅 2026-08-20 - Community-maintained listfile of known file paths inside World of Warcraft's CASC storage, used by CascLib/wow\.export and similar tools to resolve file IDs to names.
...
* [DevilutionX](https://github.com/diasurgical/DevilutionX) ⭐ 9,693 | 🐛 477 | 🌐 C++ | 📅 2026-08-15 - Actively maintained, cross-platform engine reimplementation of Diablo 1 and Hellfire that reads the original game's MPQ data files.
...
* [TXTeditor](https://github.com/yinyin333333/TXTeditor) ⭐ 4 | 🐛 4 | 🌐 JavaScript | 📅 2026-08-19 - Windows desktop editor for Diablo II / Diablo II: Resurrected tab-separated `.txt` data files and D2R JSON string files.
...
* [CWR](https://github.com/BohemiaInteractive/CWR) ⭐ 925 | 🐛 10 | 🌐 C++ | 📅 2026-08-18 - Arma: Cold War Assault (Operation Flashpoint: Cold War Crisis) Remastered - official modernized C++20 engine and game source release, reading the original game's native PBO/config data formats.
...
* [KeeperFX](https://github.com/dkfans/keeperfx) ⭐ 990 | 🐛 455 | 🌐 C | 📅 2026-08-20 - Decompiled and continuously rewritten fan port of Dungeon Keeper 1, reading the original game's data files. Long-running community project with extensive modding/campaign support.
...
* [CorsixTH](https://github.com/CorsixTH/CorsixTH) ⭐ 4,525 | 🐛 249 | 🌐 Lua | 📅 2026-08-20 - Open-source reimplementation of Theme Hospital (1997, Bullfrog Productions), reading the original game's graphics, sound, and data files.
...
* [REFramework](https://github.com/praydog/REFramework) ⭐ 5,340 | 🐛 644 | 🌐 C++ | 📅 2026-08-20 - Powerful scripting framework and mod loader for RE Engine games. Provides an overlay with a resource editor, object explorer, and various developer tools.
* [REE.PAK.Tool](https://github.com/Ekey/REE.PAK.Tool) ⭐ 390 | 🐛 4 | 🌐 C# | 📅 2026-04-22 - Tools for extracting and repacking PAK archives from games based on RE ENGINE.
...
* [REasy](https://github.com/seifhassine/REasy) ⭐ 105 | 🐛 5 | 🌐 Python | 📅 2026-08-21 - Modding toolkit for RE Engine games, with a resource packer/unpacker and file editors.
...
* [Albam](https://github.com/Brachi/albam) ⭐ 23 | 🐛 9 | 🌐 Python | 📅 2026-08-21 - Blender addon for importing and exporting 3D models and other assets from Capcom's MT Framework engine.
...
* [recvx-decomp (decomp)](https://github.com/AshfordFamily/recvx-decomp) ⭐ 213 | 🐛 2 | 🌐 C | 📅 2026-08-19 - Matching decompilation of Resident Evil - Code: Veronica X (PS2).
...
* [3sx](https://github.com/crowded-street/3sx) ⭐ 316 | 🐛 37 | 🌐 C | 📅 2026-08-20 - Native source port of Street Fighter III: 3rd Strike to modern platforms, requiring only the legally-obtained arcade ROM as a data dependency (neither a recompilation nor emulation).
...
* [MegaManZeroRecomp](https://github.com/mstan/MegaManZeroRecomp) ⭐ 4 | 🐛 0 | 🌐 C++ | 📅 2026-07-29 - Static recompilation of Mega Man Zero (GBA) into native code.
...
* [mh3g-hd-mods](https://github.com/ennsia/mh3g-hd-mods) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-08-14 - HD texture mods for Monster Hunter 3G, working with the game's original texture formats.
...
* [The-Ham-Sandwich](https://github.com/adarec1994/The-Ham-Sandwich) ⭐ 0 | 🐛 0 | 🌐 C++ | 📅 2026-08-20 - Browses WildStar's index files, renders all maps, and exports them to Blender.
...
* [WolvenKit](https://github.com/WolvenKit/WolvenKit) ⭐ 1,179 | 🐛 325 | 🌐 C# | 📅 2026-08-20 - REDEngine 4 file editor designed to simplify and accelerate modding workflow for Cyberpunk 2077.
...
* [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 8,187 | 🐛 412 | 🌐 C++ | 📅 2026-08-20 - Open-source reimplementation of Chris Sawyer's Transport Tycoon Deluxe, able to load the original game's GRF graphics/sound data files and pioneering the widely-used NewGRF format for custom vehicle/graphics data.
* [nml](https://github.com/OpenTTD/nml) ⭐ 58 | 🐛 43 | 🌐 Python | 📅 2026-08-05 - NewGRF Meta Language, a higher-level compiler for authoring OpenTTD NewGRF (GRF) content.

...
[Awesome](https://github.com/sindresorhus/awesome) ⭐ 496,682 | 🐛 100 | 📅 2026-06-30
...
* [Architecture of consoles](https://github.com/flipacholas/Architecture-of-consoles) ⭐ 1,102 | 🐛 28 | 📅 2026-08-16 - Series of technical articles on console hardware architecture, covering CPU, graphics, and file/memory layout across many platforms.
...
* [rom-properties](https://github.com/GerbilSoft/rom-properties) ⭐ 652 | 🐛 96 | 🌐 C++ | 📅 2026-08-17 - Shell extension for Windows and Linux that shows information about ROM and disc image files. Supports over 500 game and system file formats across dozens of consoles and handhelds.
...
* [gb-ctr](https://github.com/Gekkio/gb-ctr) ⭐ 432 | 🐛 2 | 🌐 Typst | 📅 2026-08-16 - Game Boy: Complete Technical Reference, an in-depth document covering Game Boy console hardware internals.
...
* [kovidomi/game-reversing](https://github.com/kovidomi/game-reversing) ⭐ 1,675 | 🐛 4 | 📅 2023-04-05 - Beginner learning materials on reverse engineering video games.
...
* [vengi](https://github.com/vengi-voxel/vengi) ⭐ 1,396 | 🐛 134 | 🌐 C | 📅 2026-08-16 - Free, open-source, actively maintained voxel editor, thumbnailer, and command-line format converter.
...
* [binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,232 | 🐛 92 | 🌐 Rust | 📅 2026-08-11 - Firmware analysis tool for identifying and extracting embedded files and data. The Rust version (v3) provides significant speed and accuracy improvements over the original Python version.
* [AssetRipper](https://github.com/AssetRipper/AssetRipper) ⭐ 8,150 | 🐛 161 | 🌐 C# | 📅 2026-08-17 - GUI tool for extracting assets from Unity serialized files (*CAB-*\\*, *\\*.assets*, etc.) and asset bundles (*\\*.unity3d\*, *\\*.bundle\*, etc.) and converting them into the native Unity engine format.
...
* [GARbro](https://github.com/morkt/GARbro) ⭐ 3,249 | 🐛 276 | 🌐 C# | 📅 2024-07-08 - Visual novels resource browser and extractor supporting many formats.
...
* [innoextract](https://github.com/dscharrer/innoextract) ⭐ 1,338 | 🐛 70 | 🌐 C++ | 📅 2025-02-06 - Extracts installers created by Inno Setup without running them, commonly used to unpack game installers before further asset processing.
...
* [OmniDrive](https://github.com/RibShark/OmniDrive) ⭐ 1,059 | 🐛 19 | 🌐 Assembly | 📅 2026-07-18 - Firmware modification for MediaTek MT1959-based Hitachi-LG optical disc drives, enabling raw sector and lead-in/lead-out reading of CD/DVD/BD media including proprietary game discs.
...
* [HxCFloppyEmulator](https://github.com/jfdelnero/HxCFloppyEmulator) ⭐ 194 | 🐛 11 | 🌐 C | 📅 2026-08-13 - HxC floppy drive emulator toolkit; reads and converts a wide range of retro floppy disk image formats, including many game-console/computer-specific ones.
...
* [fluxfox](https://github.com/dbalsom/fluxfox) ⭐ 152 | 🐛 4 | 🌐 Rust | 📅 2026-08-16 - Floppy disk image library in Rust for emulators, focused on PC platform disk images with initial Amiga/Macintosh/Atari ST support.
...
* [RIDE](https://github.com/tomas-nestorovic/RIDE) ⭐ 85 | 🐛 36 | 🌐 C++ | 📅 2026-08-16 - Windows tool for low-level raw floppy disk access and browsing legacy filesystems (ZX Spectrum, MS-DOS, and others) found on preserved game disks.
...
* [vgmstream](https://github.com/vgmstream/vgmstream) ⭐ 2,226 | 🐛 18 | 🌐 C | 📅 2026-08-14 - Audio playback library supporting 1000+ game audio formats including looping, multi-channel streams, and console-specific codecs. Works as a standalone player or Winamp/foobar2000 plugin. If a game audio file exists, vgmstream probably plays it.
* [vgmtrans](https://github.com/vgmtrans/vgmtrans) ⭐ 1,259 | 🐛 93 | 🌐 C++ | 📅 2026-08-17 - Video Game Music Translator; converts proprietary game audio sequence/soundfont formats from many games/consoles into standard MIDI/DLS/SF2.
...
* [wwiser](https://github.com/bnnm/wwiser) ⭐ 359 | 🐛 3 | 🌐 Python | 📅 2026-08-15 - Wwise .bnk explorer and audio simulator. Python tool for parsing Wwise soundbank files, viewing HIRC audio scripting data, generating TXTP files for vgmstream playback, and dumping bank contents. Works with any game using Wwise audio middleware.
...
* [ImHex](https://github.com/WerWolv/ImHex) ⭐ 54,483 | 🐛 382 | 🌐 C++ | 📅 2026-08-17 - Modern, open-source hex editor with pattern language for reverse engineering file formats (free).

#### Scripts & Templates

* [hexyl](https://github.com/sharkdp/hexyl) ⭐ 10,257 | 🐛 35 | 🌐 Rust | 📅 2026-04-30 - Command-line hex viewer with colored output.
...
* [fq](https://github.com/wader/fq) ⭐ 10,558 | 🐛 59 | 🌐 Go | 📅 2026-08-16 - "jq for binary formats" - command-line tool, language, and decoder collection for querying and inspecting binary and text formats, useful for ad-hoc exploration of unfamiliar game file formats.
* [ImHex-Patterns](https://github.com/WerWolv/ImHex-Patterns) ⭐ 994 | 🐛 49 | 🌐 Rust | 📅 2026-08-16 - Binary format pattern database for ImHex hex editor, with game file format definitions and reverse-engineering templates.
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 72,423 | 🐛 1,916 | 🌐 Java | 📅 2026-08-13 - NSA's software reverse engineering (SRE) framework. Includes disassembly, assembly, decompilation, graphing, and scripting. Extensible through Java and Python plugins.
* [Cutter](https://github.com/rizinorg/cutter) ⭐ 19,470 | 🐛 492 | 🌐 C++ | 📅 2026-08-13 - Free and open-source GUI-based reverse engineering platform powered by Rizin, for analyzing game binaries and file formats.
...
* [qiling](https://github.com/qilingframework/qiling) ⭐ 6,063 | 🐛 123 | 🌐 Python | 📅 2026-07-22 - Advanced binary emulation framework. Emulates multi-platforms (Windows, macOS, Linux, Android, BSD, UEFI, DOS) and multi-architectures (x86, ARM, MIPS, RISC-V, PowerPC). Supports PE, Mach-O, ELF formats with fine-grain instrumentation, cross-architecture debugging, and dynamic hot patching.
* [Steamless](https://github.com/atom0s/Steamless) ⭐ 4,969 | 🐛 25 | 🌐 C# | 📅 2024-03-30 - DRM remover for the SteamStub packer variants, unpacking Steam-protected game executables to enable further static/dynamic analysis of the underlying binary.
* [diaphora](https://github.com/joxeankoret/diaphora) ⭐ 4,371 | 🐛 39 | 🌐 Python | 📅 2026-07-29 - Advanced binary diffing tool (IDA/Binary Ninja/Ghidra) for comparing game binaries across versions/patches, widely used in game reverse engineering workflows.
...
* [SafeDiscShim](https://github.com/RibShark/SafeDiscShim) ⭐ 559 | 🐛 36 | 🌐 C++ | 📅 2025-09-29 - Compatibility tool that allows SafeDisc-protected games relying on the insecure Macrovision Security Driver (secdrv.sys) to run on modern versions of Windows, enabling further analysis of the underlying game binaries.
...
* [Recaf](https://github.com/Col-E/Recaf) ⭐ 7,338 | 🐛 66 | 🌐 Java | 📅 2026-08-17 - Modern Java bytecode editor. Easy-to-use interface for editing Java bytecode with decompiler integration, built-in compiler, bytecode assembler, and support for standard Java and Android applications.
* [JPEXS Free Flash Decompiler](https://github.com/jindrapetrik/jpexs-decompiler) ⭐ 5,805 | 🐛 5 | 🌐 Java | 📅 2026-08-08 - Free Flash (SWF) decompiler/editor for viewing and modifying ActionScript 1/2/3 bytecode, shapes, sprites, sounds, and other tags in SWF files, widely used for reverse-engineering Flash-based games.
...
* [decomp.me](https://github.com/decompme/decomp.me) ⭐ 599 | 🐛 126 | 🌐 TypeScript | 📅 2026-08-16 - Collaborative decompilation and reverse engineering website, widely used to reverse game binaries function-by-function against a reference build.
* [objdiff](https://github.com/encounter/objdiff) ⭐ 516 | 🐛 91 | 🌐 Rust | 📅 2026-08-11 - Local diffing tool for decompilation projects.
...
* [ds-decomp](https://github.com/AetiasHax/ds-decomp) ⭐ 82 | 🐛 8 | 🌐 Rust | 📅 2026-08-14 - Toolkit for decompiling Nintendo DS games, with ROM extraction, building, symbol analysis, and asset handling tools.
...
* [XenonRecomp](https://github.com/hedge-dev/XenonRecomp) ⭐ 6,439 | 🐛 90 | 🌐 C++ | 📅 2025-08-04 - Tool for recompiling Xbox 360 games to native executables. Converts Xbox 360 executables into C++ code that can be recompiled for any platform.
...
* [SR (Static Recompiler)](https://github.com/M-HT/SR) ⭐ 406 | 🐛 11 | 🌐 C | 📅 2026-08-16 - Static recompilation project that converts several classic DOS games into native Windows/Linux (x86/ARM) ports (Albion, Septerra Core, X-COM, Warcraft: Orcs & Humans, and others).
...
* [binocle](https://github.com/sharkdp/binocle) ⭐ 1,314 | 🐛 25 | 🌐 Rust | 📅 2025-01-21 - Graphical binary data visualization tool. Colorizes bytes and renders them as pixels to identify patterns and image-like structures in game files.
...
* [PINCE](https://github.com/korcankaraokcu/PINCE) ⭐ 3,059 | 🐛 6 | 🌐 Python | 📅 2026-08-15 - GDB front-end/reverse engineering tool with a Cheat Engine-like interface for Linux.
...
* [pcsx-redux](https://github.com/grumpycoders/pcsx-redux) ⭐ 982 | 🐛 150 | 🌐 C++ | 📅 2026-08-12 - Collection of tools, research, hardware design, and libraries for PlayStation 1 development and reverse engineering, built around a fork of the PCSX emulator with an integrated debugger, assembler, and GPU/memory analysis tooling.
...
* [binrw](https://github.com/jam1garner/binrw) ⭐ 844 | 🐛 38 | 🌐 Rust | 📅 2026-07-23 - Rust library for reading and writing binary file formats with derive macros. Successor to `binread`.
* [WLA-DX](https://github.com/vhelin/wla-dx) ⭐ 605 | 🐛 28 | 🌐 C | 📅 2026-08-14 - Multi-target assembler/linker toolchain (Z80, 6502, 65816, SPC700, HuC6280, Game Boy) widely used across retro console ROM hacking and homebrew development.
...
* [noclip.website](https://github.com/magcius/noclip.website) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser 3D viewer for 100+ games across multiple platforms and studios.
...
* [diii4a](https://github.com/glKarin/com.n0n3m4.diii4a) ⭐ 589 | 🐛 158 | 🌐 C | 📅 2026-08-16 - Multi-engine Android/desktop port collection for idTech-derived games, reading each game's original assets.
...
* [MeltyTool](https://github.com/MeltyPlayer/MeltyTool) ⭐ 201 | 🐛 60 | 🌐 C# | 📅 2026-08-15 - Multitool for viewing/extracting assets from various N64/GCN/3DS/PC games.
...
* [ScummVM](https://github.com/scummvm/scummvm) ⭐ 2,776 | 🐛 36 | 🌐 C++ | 📅 2026-08-17 - The canonical multi-engine interpreter that reimplements dozens of classic adventure/RPG engines, reading each game's original data files instead of emulating a CPU.
...
* [resource\_dasm](https://github.com/fuzziqersoftware/resource_dasm) ⭐ 151 | 🐛 11 | 🌐 C++ | 📅 2026-08-10 - Classic Mac OS resource fork disassembler and reverse-engineering toolkit, with format decoders for dozens of classic Macintosh games.
...
* [BizHawk](https://github.com/TASEmulators/BizHawk) ⭐ 2,728 | 🐛 789 | 🌐 C# | 📅 2026-08-17 - Multi-system emulator built for tool-assisted speedrunning, with full rerecording, RAM search/watch, Lua scripting, and debugging tools across 20+ systems (NES, SNES, Genesis, Game Boy/GBA, N64, PS1, and more).
...
* [UndertaleModTool](https://github.com/UnderminersTeam/UndertaleModTool) ⭐ 1,998 | 🐛 318 | 🌐 C# | 📅 2026-08-17 - Tool for modding/decompiling GameMaker games.
...
* [cinnamon](https://github.com/Project-Sunshine-Native/cinnamon) ⭐ 366 | 🐛 11 | 🌐 C | 📅 2026-08-14 - GameMaker runtime reimplementation ('Cinnamon') that loads original compiled GameMaker game data, in the tradition of phosphorvm and OpenGMK.
...
* [halflife](https://github.com/ValveSoftware/halflife) ⭐ 4,339 | 🐛 2,122 | 🌐 C++ | 📅 2024-10-02 - Valve's official Half-Life 1 SDK source release, containing the client/server game-logic DLL source that defines GoldSrc's original data formats.
* [noclip.website (Source Engine)](https://github.com/magcius/noclip.website/tree/main/src/SourceEngine) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser Source engine map viewer supporting Counter-Strike: Source, Day of Defeat: Source, Half-Life 2, Half-Life 2: Deathmatch, Half-Life 2: Lost Coast, Half-Life 2: Episode 1, Half-Life 2: Episode 2, Team Fortress 2, Portal, Portal 2, Counter-Strike: Global Offensive, Left 4 Dead 2, The Stanley Parable, Infra, Neo Tokyo, and Estranged: Act I.
* [noclip.website (GoldSrc)](https://github.com/magcius/noclip.website/tree/main/src/GoldSrc) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser GoldSrc map viewer supporting Half-Life, Counter-Strike, Team Fortress Classic, and Day of Defeat.
* [xash3d-fwgs](https://github.com/FWGS/xash3d-fwgs) ⭐ 2,718 | 🐛 446 | 🌐 C | 📅 2026-08-16 - Cross-platform reimplementation of the GoldSrc engine, loading original Half-Life BSP/WAD/MDL game data. Actively maintained; companion to hlsdk-portable.
* [ValveResourceFormat](https://github.com/ValveResourceFormat/ValveResourceFormat) ⭐ 2,374 | 🐛 73 | 🌐 C# | 📅 2026-08-16 - Source 2 Viewer is a powerful tool that allows you to browse VPK archives, view, extract, and decompile Source 2 assets, including maps, models, materials, textures, sounds, and more. Also includes C# library for reading and writing Valve Source engine resource files.
...
* [Crowbar](https://github.com/ZeqMacaw/Crowbar) ⭐ 810 | 🐛 45 | 🌐 Visual Basic .NET | 📅 2026-08-08 - All-in-one GoldSource and Source Engine modding tool: decompile/compile MDL model files, unpack game packages, and publish addons to Steam Workshop.
...
* [hlsdk-portable](https://github.com/FWGS/hlsdk-portable) ⭐ 393 | 🐛 51 | 🌐 C++ | 📅 2026-08-05 - Cross-platform, actively maintained continuation of the Half-Life SDK for GoldSource and Xash3D, used to build original HL1 mod DLLs on modern OSes.
...
* [WifeRadiant](https://github.com/erysdren/WifeRadiant) ⭐ 112 | 🐛 6 | 🌐 C++ | 📅 2026-08-16 - Open-source, cross-platform level editor for idTech, Source Engine, and GoldSrc based games; modern fork of NetRadiant.
...
* [VPKEdit](https://github.com/craftablescience/VPKEdit) ⭐ 726 | 🐛 49 | 🌐 C++ | 📅 2026-08-10 - Cross-platform GUI and CLI tool for creating, reading, and writing many pack file formats used across Source, GoldSrc, and Quake-family games.
...
* [SourceIO](https://github.com/REDxEYE/SourceIO) ⭐ 954 | 🐛 15 | 🌐 Python | 📅 2026-08-14 - Blender 3.6+ addon for importing Source Engine assets (models, maps, textures, materials) for both Source 1 and Source 2.
...
* [XUnity.AutoTranslator](https://github.com/bbepis/XUnity.AutoTranslator) ⭐ 3,339 | 🐛 446 | 🌐 C# | 📅 2026-07-24 - Universal translation framework for Unity games. Supports automatic text translation with various translator backends and IL2CPP support.
...
* [Cpp2IL](https://github.com/SamboyCoding/Cpp2IL) ⭐ 2,573 | 🐛 45 | 🌐 C# | 📅 2026-08-14 - Decompiler for Unity IL (Intermediate Language) code and assets.
* [UABEA (Unity Asset Bundle Extractor Avalonia)](https://github.com/nesrak1/UABEA) ⭐ 2,386 | 🐛 144 | 🌐 C# | 📅 2026-05-11 - C# UABE for newer versions of Unity. Cross-platform Unity asset bundle and serialized file editor/extractor built with Avalonia.
* [AssetStudio (aelurum fork)](https://github.com/aelurum/AssetStudio) ⭐ 2,013 | 🐛 51 | 🌐 C# | 📅 2025-10-15 - Actively maintained fork with UI optimization and enhancements.
...
* [UABEANext](https://github.com/nesrak1/UABEANext) ⭐ 382 | 🐛 4 | 🌐 C# | 📅 2026-07-27 - Research and modding tool for SerializedFiles and Asset Bundles.
...
* [UnrealTournamentPatches](https://github.com/OldUnreal/UnrealTournamentPatches) ⭐ 1,471 | 🐛 556 | 📅 2026-08-15 - Community patch project for the original Unreal Tournament (1999) and Unreal (1998), maintaining and extending the original engine while reading the games' original asset formats.
* [SurrealEngine](https://github.com/dpjudas/SurrealEngine) ⭐ 1,092 | 🐛 15 | 🌐 C++ | 📅 2026-08-17 - Reimplementation of the Unreal Engine 1 engine that reads original Unreal/Unreal Tournament package/map assets to make the games playable on modern systems.
...
* [CUE4Parse](https://github.com/FabianFG/CUE4Parse) ⭐ 609 | 🐛 24 | 🌐 C# | 📅 2026-08-16 - C# Parser for UE archives.
...
* [UEFormat](https://github.com/h4lfheart/UEFormat) ⭐ 321 | 🐛 2 | 🌐 Python | 📅 2026-08-14 - Library for working with Unreal Engine file formats.
...
* [FModel](https://github.com/4sval/FModel) ⭐ 3,046 | 🐛 13 | 🌐 C# | 📅 2026-08-15 - Explorer and asset viewer for Unreal Engine archives, supporting UE4 and UE5.
...
* [UEViewer (UModel)](https://github.com/gildor2/UEViewer) ⭐ 2,913 | 🐛 26 | 🌐 C++ | 📅 2024-03-16 - Viewer and exporter for Unreal Engine 1-4 assets (UE Viewer).
...
* [Snooper](https://github.com/FModel/Snooper/tree/opengl) ⭐ 13 | 🐛 0 | 🌐 C# | 📅 2026-08-16 - OpenGL based 3D viewer for cooked UE packages.
...
* [UEVR](https://github.com/praydog/UEVR) ⭐ 4,451 | 🐛 209 | 🌐 C++ | 📅 2026-07-26 - Universal Unreal Engine VR Mod. Powerful runtime reversing tool that provides an overlay for inspecting objects, classes, and properties in almost any UE4/5 game.
* [Dumper-7](https://github.com/Encryqed/Dumper-7) ⭐ 2,171 | 🐛 36 | 🌐 C | 📅 2026-08-06 - Unreal Engine SDK generator supporting all UE4 and UE5 versions, dumping engine classes/structs/offsets from a running game via DLL injection; the de facto standard modern UE SDK dumper and basis for several other tools already listed (e.g. UETools-GUI).
* [UEDumper](https://github.com/Spuckwaffel/UEDumper) ⭐ 1,376 | 🐛 0 | 🌐 C++ | 📅 2026-04-18 - UE 4.19-5.3 reverse engineering tool for dumping SDK, analyzing structures, and identifying memory offsets.
...
* [UETools-GUI](https://github.com/Cranch-fur/UETools-GUI) ⭐ 77 | 🐛 0 | 🌐 C++ | 📅 2026-08-17 - Dumper-7 based GUI tool for rapid debugging and SDK extraction from Unreal Engine games.
...
* [RE-UE4SS](https://github.com/UE4SS-RE/RE-UE4SS) ⭐ 2,804 | 🐛 254 | 🌐 C++ | 📅 2026-08-16 - Lua scripting system, SDK generator, blueprint mod loader, and live property editor for UE4/5 games.
...
* [UE\_Modding](https://github.com/Dmgvol/UE_Modding) ⭐ 574 | 🐛 0 | 📅 2026-06-10 - Comprehensive collection of guides and resources for modding Unreal Engine 4 and 5 games.
...
* [io\_scene\_psk\_psa](https://github.com/DarklightGames/io_scene_psk_psa) ⭐ 619 | 🐛 4 | 🌐 Python | 📅 2026-07-16 - Blender addon for importing and exporting PSK (skeletal mesh) and PSA (animation) formats used in Unreal Engine. Supports PSK/PSKX mesh import with vertex normals, extra UV channels, vertex colors, and shape keys.
...
* [Dagor Engine](https://github.com/GaijinEntertainment/DagorEngine) ⭐ 2,948 | 🐛 74 | 🌐 C++ | 📅 2026-08-16 - Open-source release of the Dagor Engine (War Thunder, Enlisted) including parts of the toolchain.
...
* [cobra-tools](https://github.com/OpenNaja/cobra-tools) ⭐ 152 | 🐛 17 | 🌐 Python | 📅 2026-08-16 - Suite of GUI tools for extracting and modifying OVL and OVS archives, as well as editing associated file formats and models for the Cobra Engine (Frontier Developments).
...
* [Parchment](https://github.com/curiousdannii/parchment) ⭐ 483 | 🐛 42 | 🌐 TypeScript | 📅 2026-08-16 - The actively maintained successor to Andrew Plotkin's original Parchment web interactive-fiction player, running Z-machine and Glulx games in the browser via WASM-compiled interpreters (through the Emglken/Glk bridge).
...
* [Ruffle](https://github.com/ruffle-rs/ruffle) ⭐ 18,433 | 🐛 5,621 | 🌐 Rust | 📅 2026-08-17 - Flash Player emulator written in Rust that parses and executes SWF files and ActionScript bytecode, used to preserve and play thousands of Flash-based web games.
...
* [gdsdecomp](https://github.com/GDRETools/gdsdecomp) ⭐ 4,067 | 🐛 35 | 🌐 C++ | 📅 2026-08-16 - Godot reverse engineering toolkit for game file format recovery, GDScript bytecode decompilation, and PCK archive extraction (Godot 2.x, 3.x, 4.x).
...
* [noclip.website (Banjo)](https://github.com/magcius/noclip.website/blob/main/src/BanjoKazooie/f3dex.ts) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - F3DEX implementation for Banjo-Kazooie viewer.
...
* [fast64](https://github.com/Fast-64/fast64) ⭐ 523 | 🐛 77 | 🌐 Python | 📅 2026-08-15 - Blender plugin for exporting F3D display lists for N64 decompilation projects (Super Mario 64, Ocarina of Time).
* [MeltyTool (F3dzex2)](https://github.com/MeltyPlayer/MeltyTool/tree/main/FinModelUtility/Libraries/F3dzex2) ⭐ 201 | 🐛 60 | 🌐 C# | 📅 2026-08-15 - F3DZEX2 format support.
...
* [noclip.website (JSYSTEM)](https://github.com/magcius/noclip.website/tree/main/src/Common/JSYSTEM) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser viewer for JSYSTEM formats.
* [aurora](https://github.com/encounter/aurora) ⭐ 456 | 🐛 9 | 🌐 C++ | 📅 2026-08-16 - Source-level GameCube & Wii GX graphics compatibility layer, used by decompilation and static-recompilation projects to run original GC/Wii rendering code on modern backends (Dawn/WebGPU).
* [MeltyTool (JSystem)](https://github.com/MeltyPlayer/MeltyTool/tree/main/FinModelUtility/Libraries/JSystem) ⭐ 201 | 🐛 60 | 🌐 C# | 📅 2026-08-15 - JSystem format viewer/exporter.
...
* [MMD Tools](https://github.com/MMD-Blender/blender_mmd_tools) ⭐ 3,211 | 🐛 13 | 🌐 Python | 📅 2026-08-13 - Blender add-on for importing/exporting MikuMikuDance assets. Supports physics, bone constraints, and motion/pose data.
...
* [DragonFF](https://github.com/Parik27/DragonFF) ⭐ 515 | 🐛 77 | 🌐 Python | 📅 2026-08-16 - Blender add-on for RenderWare `.dff` models, `.txd` textures, `.col` collisions, and `.ipl` map data.
...
* [FNA](https://github.com/FNA-XNA/FNA) ⭐ 3,031 | 🐛 58 | 🌐 C# | 📅 2026-08-16 - Accuracy-focused reimplementation of the XNA4 framework for modern platforms, reading original .xnb content files; widely used to port XNA-based games (Terraria, Bastion, Fez, and others).
...
* [Goldleaf](https://github.com/XorTroll/Goldleaf) ⭐ 3,021 | 🐛 91 | 🌐 C | 📅 2026-05-16 - Multi-purpose homebrew tool for the Nintendo Switch, browsing/installing NSP and NCA titles and inspecting the filesystem.
* [nsz](https://github.com/nicoboss/nsz) ⭐ 2,342 | 🐛 36 | 🌐 Python | 📅 2026-08-13 - Homebrew-compatible NSP/XCI compressor and decompressor for Nintendo Switch game dumps.
...
* [SimpleModManager](https://github.com/nadrino/SimpleModManager) ⭐ 459 | 🐛 21 | 🌐 C++ | 📅 2026-02-23 - Homebrew mod manager for the Nintendo Switch (Atmosphere CFW), organizing LayeredFS mod overlay folders per game title ID.
...
* [noclip.website (Wii U Transfer Tool)](https://github.com/magcius/noclip.website/tree/main/src/rres) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser viewer for the Wii U Transfer Tool's scenes, reading the app's NW4R/BRRES assets.
...
* [Checkpoint](https://github.com/BernardoGiordano/Checkpoint) ⭐ 3,049 | 🐛 33 | 🌐 C++ | 📅 2026-08-13 - Fast and simple homebrew save management framework for 3DS and Switch.
...
* [Anemone3DS](https://github.com/astronautlevel2/Anemone3DS) ⭐ 1,137 | 🐛 31 | 🌐 C | 📅 2026-03-04 - Theme and splashscreen manager for the Nintendo 3DS, handling BCSTM audio and theme/splash archive formats.
...
* [Dolphin](https://github.com/dolphin-emu/dolphin) ⭐ 15,408 | 🐛 460 | 🌐 C++ | 📅 2026-08-16 - GameCube and Wii emulator that parses and implements support for GameCube/Wii disc and asset file formats.
* [noclip.website (Wii Banners)](https://github.com/magcius/noclip.website/tree/main/src/Common/NW4R/lyt) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - Renderer for NW4R LYT UI layouts, used to play back animated Wii channel banners from `banner.bin` archives. Parses BRLYT layouts, BRLAN animations, and NW4R bitmap fonts.
...
* [nod](https://github.com/encounter/nod) ⭐ 62 | 🐛 14 | 🌐 Rust | 📅 2026-07-17 - Rust library for reading and writing Nintendo Optical Disc images (GameCube and Wii). Includes nodtool CLI for extraction, conversion, and verification.
...
* [N64Recomp](https://github.com/N64Recomp/N64Recomp) ⭐ 8,032 | 🐛 57 | 🌐 C++ | 📅 2026-05-27 - Tool to statically recompile N64 games into native executables. Converts N64 binaries into C code that can be compiled for any platform.
...
* [gb-schematics](https://github.com/Gekkio/gb-schematics) ⭐ 695 | 🐛 0 | 📅 2024-05-18 - Reverse engineered Game Boy-related hardware schematics.
...
* [OpenCiv3](https://github.com/C7-Game/OpenCiv3) ⭐ 637 | 🐛 99 | 🌐 C# | 📅 2026-08-05 - Open-source Civilization III remake with tools for parsing and importing original Civ3 game data.
...
* [fheroes2](https://github.com/ihhub/fheroes2) ⭐ 3,435 | 🐛 434 | 🌐 C++ | 📅 2026-08-13 - Recreation of Heroes of Might and Magic II game engine that requires and parses original .AGG archive format, providing high-resolution graphics and improved AI.

#### Heroes of Might and Magic III

* [vcmi](https://github.com/vcmi/vcmi) ⭐ 5,782 | 🐛 715 | 🌐 C++ | 📅 2026-08-16 - Open-source reimplementation of the Heroes of Might and Magic III engine, loading and reading the original game's data files (H3sprite.lod, Heroes3.exe resources, maps, campaigns).
...
* [spidey-decomp](https://github.com/krystalgamer/spidey-decomp) ⭐ 120 | 🐛 6 | 🌐 C | 📅 2026-08-16 - Decompilation of Neversoft's Spider-Man (PC port), useful for studying formats and game internals.
...
* [noclip.website (Neon White)](https://github.com/magcius/noclip.website/tree/main/src/NeonWhite) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser Neon White viewer.
...
* [MeltyTool](https://github.com/MeltyPlayer/MeltyTool/tree/main/FinModelUtility/Libraries/AngelStudios) ⭐ 201 | 🐛 60 | 🌐 C# | 📅 2026-08-15 - Multitool for viewing/extracting assets from various N64/GCN/3DS/PC games en-masse.
...
* [mother3 (decomp)](https://github.com/Kurausukun/mother3) ⭐ 79 | 🐛 6 | 🌐 Assembly | 📅 2026-08-17 - Decompilation of Mother 3 (GBA).
...
* [noclip.website (Klonoa)](https://github.com/magcius/noclip.website/tree/main/src/rres) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser Klonoa viewer.
* [noclip.website (Katamari Damacy)](https://github.com/magcius/noclip.website/tree/main/src/KatamariDamacy) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser Katamari Damacy viewer.
...
* [OpenMW](https://github.com/OpenMW/openmw) ⭐ 6,517 | 🐛 0 | 🌐 C++ | 📅 2026-08-16 - Open-source unofficial engine reimplementation of Morrowind that reads and parses the original game's ESM/ESP plugin files and BSA archives to run without Bethesda's original engine.
* [noclip.website (Morrowind)](https://github.com/magcius/noclip.website/tree/main/src/Morrowind) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser Morrowind viewer.
* [daggerfall-unity](https://github.com/Interkarma/daggerfall-unity) ⭐ 3,466 | 🐛 76 | 🌐 C# | 📅 2026-06-30 - Open-source recreation of The Elder Scrolls II: Daggerfall in the Unity engine, reverse-engineering and loading the original Daggerfall (DOS) game data and formats.
* [OpenTESArena](https://github.com/afritz1/OpenTESArena) ⭐ 1,391 | 🐛 19 | 🌐 C++ | 📅 2026-08-13 - Open-source reimplementation of The Elder Scrolls: Arena's engine that reads the original game's data files (CFA, IMG, SET, and other Arena-specific formats).
...
* [PyNifly](https://github.com/BadDogSkyrim/PyNifly) ⭐ 301 | 🐛 116 | 🌐 Python | 📅 2026-08-16 - Export/import tools between Blender and the NIF format, using Bodyslide/Outfit Studio's Nifly layer. Supports Skyrim LE, Skyrim SE, Fallout 4, Fallout New Vegas, Fallout 76, and Fallout 3.
...
* [StormLib](https://github.com/ladislav-zezula/StormLib) ⭐ 648 | 🐛 1 | 🌐 C | 📅 2026-08-16 - Official library for reading and writing MPQ (MoPaQ) archives, the format used by Warcraft III, StarCraft, Diablo, and World of Warcraft (pre-Cataclysm).
...
* [noclip.website (World of Warcraft - Vanilla, The Burning Crusade, Wrath of the Lich King)](https://github.com/magcius/noclip.website/tree/main/src/WorldOfWarcraft) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser World of Warcraft (Vanilla) viewer.
* [WoWee](https://github.com/Kelsidavis/WoWee) ⭐ 638 | 🐛 1 | 🌐 C++ | 📅 2026-08-17 - Native C++ World of Warcraft client reimplementation with a custom Vulkan renderer, parsing original WMO/M2 model and terrain data.
...
* [Prometheus](https://github.com/saturn-xvi/prometheus) ⭐ 592 | 🐛 9 | 🌐 C++ | 📅 2026-05-15 - Research and reverse-engineering project documenting Overwatch game internals including managers, ECS, STU, data structures, game messages, and components.
...
* [DevilutionX](https://github.com/diasurgical/DevilutionX) ⭐ 9,689 | 🐛 477 | 🌐 C++ | 📅 2026-08-15 - Actively maintained, cross-platform engine reimplementation of Diablo 1 and Hellfire that reads the original game's MPQ data files.
...
* [noclip.website (Top Gear Rally)](https://github.com/magcius/noclip.website/tree/main/src/TopGearRally) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser Top Gear Rally (N64) track viewer covering all five tracks plus mirrored variants, with a Python extractor for pulling track data out of the ROM. Renders spline-animated scenery, animated textures, and reflections on top of an F3DEX display-list interpreter.
...
* [REE.PAK.Tool](https://github.com/Ekey/REE.PAK.Tool) ⭐ 387 | 🐛 5 | 🌐 C# | 📅 2026-04-22 - Tools for extracting and repacking PAK archives from games based on RE ENGINE.
...
* [REasy](https://github.com/seifhassine/REasy) ⭐ 105 | 🐛 5 | 🌐 Python | 📅 2026-08-16 - Modding toolkit for RE Engine games, with a resource packer/unpacker and file editors.
...
* [REE-Content-Editor](https://github.com/kagenocookie/REE-Content-Editor) ⭐ 98 | 🐛 11 | 🌐 C# | 📅 2026-08-16 - Mod development editor and file patcher for RE Engine games.
...
* [recvx-decomp (decomp)](https://github.com/AshfordFamily/recvx-decomp) ⭐ 216 | 🐛 2 | 🌐 C | 📅 2026-08-17 - Matching decompilation of Resident Evil - Code: Veronica X (PS2).
...
* [WolvenKit](https://github.com/WolvenKit/WolvenKit) ⭐ 1,181 | 🐛 339 | 🌐 C# | 📅 2026-08-16 - REDEngine 4 file editor designed to simplify and accelerate modding workflow for Cyberpunk 2077.
...
* [OpenTTD](https://github.com/OpenTTD/OpenTTD) ⭐ 8,175 | 🐛 411 | 🌐 C++ | 📅 2026-08-17 - Open-source reimplementation of Chris Sawyer's Transport Tycoon Deluxe, able to load the original game's GRF graphics/sound data files and pioneering the widely-used NewGRF format for custom vehicle/graphics data.
...
* [noclip.website (Okami)](https://github.com/magcius/noclip.website/tree/main/src/rres) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser Okami viewer.
...
* [OpenLara](https://github.com/XProger/OpenLara) ⭐ 5,059 | 🐛 167 | 🌐 C | 📅 2026-07-26 - Open-source reimplementation of the classic Tomb Raider engine, reading the original games' level and asset data.
...
* [TRX](https://github.com/LostArtefacts/TRX) ⭐ 967 | 🐛 157 | 🌐 C | 📅 2026-08-16 - Open-source re-implementation of Tomb Raider I, II, and III that reads the original games' level and asset data (PHD/TR2 formats) while adding enhancements and bug fixes.
...
* [Tomb-Editor](https://github.com/TombEngine/Tomb-Editor) ⭐ 125 | 🐛 202 | 🌐 C# | 📅 2026-08-16 - Level editor for the classic Tomb Raider engines and custom engines such as TombEngine and TRX.
...
* [trview](https://github.com/chreden/trview) ⭐ 43 | 🐛 52 | 🌐 C++ | 📅 2026-08-16 - Level visualizer for Tomb Raider 1-5 with speedrunning in mind. View room layouts, triggers, and analyze route possibilities.
...
* [Librelancer](https://github.com/Librelancer/Librelancer) ⭐ 603 | 🐛 86 | 🌐 C# | 📅 2026-08-17 - Open-source reimplementation of the Freelancer engine in C# and OpenGL, requiring a Freelancer installation for original game data.
...
* [noclip.website (Psychonauts)](https://github.com/magcius/noclip.website/tree/main/src/psychonauts) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser Psychonauts viewer.
...
* [noclip.website (Naruto: Gekitō Ninja Taisen! 4)](https://github.com/magcius/noclip.website/tree/main/src/NarutoGNT4) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser stage viewer for Naruto: Gekitō Ninja Taisen! 4 (GameCube), the Japan-only fourth entry in the series known in the West as Naruto: Clash of Ninja. Unpacks the game's FPK archives and their compression.
...
* [noclip.website (Need for Speed: Most Wanted)](https://github.com/magcius/noclip.website/tree/main/src/NeedForSpeedMostWanted) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser Need for Speed: Most Wanted viewer.
* [OpenNFS](https://github.com/OpenNFS/OpenNFS) ⭐ 819 | 🐛 4 | 🌐 C++ | 📅 2026-06-21 - Reverse-engineered asset loaders for Need for Speed games 1-6 (PC and PSX), extracting tracks, cars, images, music, and other assets for modern engine integration.
...
* [noclip.website (DarkSouls)](https://github.com/magcius/noclip.website/tree/main/src/DarkSouls) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser Dark Souls map viewer.
* [noclip.website (Dark Souls collision)](https://github.com/magcius/noclip.website/tree/main/src/DarkSoulsCollisionData) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - Separate in-browser viewer for Dark Souls' collision geometry, rendering the hit meshes independently of the visual map data.
...
* [PKHeX](https://github.com/kwsch/PKHeX) ⭐ 5,048 | 🐛 2 | 🌐 C# | 📅 2026-08-16 - Universal save file editor for Pokémon games. Supports all generations from Gen I to the latest Switch titles. Includes tools for legitimacy checking, PID/IV generation, and more.
...
* [pokefirered (decomp)](https://github.com/pret/pokefirered) ⭐ 1,554 | 🐛 25 | 🌐 C | 📅 2026-08-04 - Matching decompilation of Pokémon FireRed (100%).
...
* [pokegold-spaceworld (decomp)](https://github.com/pret/pokegold-spaceworld) ⭐ 393 | 🐛 3 | 🌐 Assembly | 📅 2026-08-16 - Matching decompilation of Pokémon Gold (SpaceWorld Demo) (100%).
...
* [pokeemerald (decomp)](https://github.com/pret/pokeemerald) ⭐ 3,386 | 🐛 84 | 🌐 C | 📅 2026-08-04 - Matching decompilation of Pokémon Emerald (100%).
...
* [porydaw](https://github.com/huderlem/porydaw) ⭐ 16 | 🐛 0 | 🌐 C++ | 📅 2026-08-17 - Music editor for the Pokémon Generation 3 decompilation projects that edits the game's native music data format.
* [poryaaaa](https://github.com/huderlem/poryaaaa) ⭐ 15 | 🐛 1 | 🌐 C | 📅 2026-08-16 - Audio synthesizer emulating the GBA's native m4a (Sappy) sound engine, used to author music compatible with the Gen III decompilation projects.
...
* [pokeplatinum (decomp)](https://github.com/pret/pokeplatinum) ⭐ 507 | 🐛 15 | 🌐 C | 📅 2026-08-17 - Matching decompilation of Pokémon Platinum (100%).
...
* [pokestadium (decomp)](https://github.com/pret/pokestadium) ⭐ 198 | 🐛 6 | 🌐 C | 📅 2026-08-15 - Matching decompilation of Pokémon Stadium (100%).
...
* [pokepinballrs (decomp)](https://github.com/pret/pokepinballrs) ⭐ 138 | 🐛 8 | 🌐 Assembly | 📅 2026-08-17 - Matching decompilation of Pokémon Pinball: Ruby & Sapphire (100%).
...
* [noclip.website (Ragnarok Online)](https://github.com/magcius/noclip.website/tree/main/src/RagnarokOnline) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser Ragnarok Online map viewer.
...
* [noclip.website (OoT3D)](https://github.com/magcius/noclip.website/tree/main/src/OcarinaOfTime3D) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser Ocarina of Time 3D viewer.
* [noclip.website (Luigi's Mansion 3D)](https://github.com/magcius/noclip.website/tree/main/src/OcarinaOfTime3D) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser Luigi's Mansion 3D viewer, sharing Grezzo's CMB/ZAR/ZSI loader with the OoT3D and Majora's Mask 3D viewers.
...
* [MeltyTool (Grezzo)](https://github.com/MeltyPlayer/MeltyTool/tree/main/FinModelUtility/Libraries/Grezzo) ⭐ 201 | 🐛 60 | 🌐 C# | 📅 2026-08-15 - Grezzo format viewer/exporter.
...
* [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,542 | 🐛 292 | 🌐 C++ | 📅 2026-07-30 - Community-maintained, improved version of GSC Game World's X-Ray Engine (S.T.A.L.K.E.R.: Shadow of Chernobyl / Clear Sky / Call of Pripyat) that loads and renders the original games' assets and archives.
...
* [ixray-1.6-stcop](https://github.com/ixray-team/ixray-1.6-stcop) ⭐ 436 | 🐛 70 | 🌐 C++ | 📅 2026-08-16 - Actively maintained, modernized continuation of the X-Ray engine (S.T.A.L.K.E.R.), reading the series' original game data files. See also [ixray-1.5-stcs](https://github.com/ixray-team/ixray-1.5-stcs) ⭐ 38 | 🐛 0 | 🌐 C++ | 📅 2026-01-29, the same team's stable X-Ray 1.5 branch.
...
* [noclip.website (Melee)](https://github.com/magcius/noclip.website/tree/main/src/SuperSmashBrosMelee) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser Melee stage viewer.
* [noclip.website (Super Smash Bros Brawl)](https://github.com/magcius/noclip.website/tree/main/src/rres) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser Super Smash Bros Brawl viewer.
* [noclip.website (SYSDOLPHIN)](https://github.com/magcius/noclip.website/tree/main/src/SYSDOLPHIN) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser SYSDOLPHIN format viewer.
* [noclip.website (Kirby Air Ride)](https://github.com/magcius/noclip.website/tree/main/src/KirbyAirRide) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser Kirby Air Ride viewer.
* [noclip.website (Kirby's Return to Dream Land)](https://github.com/magcius/noclip.website/tree/main/src/rres) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser Kirby's Return to Dream Land viewer.
* [melee (decomp)](https://github.com/doldecomp/melee) ⭐ 995 | 🐛 32 | 🌐 C | 📅 2026-08-17 - Matching decompilation of Super Smash Bros. Melee.
...
* [kirby64 (decomp)](https://github.com/Kirby64Ret/kirby64) ⭐ 227 | 🐛 3 | 🌐 Assembly | 📅 2026-08-17 - Work-in-progress decompilation of Kirby 64: The Crystal Shards (N64).
* [MeltyTool (Sysdolphin)](https://github.com/MeltyPlayer/MeltyTool/tree/main/FinModelUtility/Libraries/Sysdolphin) ⭐ 201 | 🐛 60 | 🌐 C# | 📅 2026-08-15 - Sysdolphin format viewer/exporter.
...
* [brawl (decomp)](https://github.com/doldecomp/brawl) ⭐ 73 | 🐛 3 | 🌐 C++ | 📅 2026-08-17 - Matching decompilation of Super Smash Bros. Brawl.
...
* [frogger2-vss](https://github.com/HighwayFrogs/frogger2-vss) ⭐ 115 | 🐛 0 | 🌐 C | 📅 2023-05-08 - Import of the Frogger 2 Visual Source Safe backup ('End of Project' tape backup), the primary source archive the other HighwayFrogs Frogger 2 platform repos derive from.
...
* [noclip.website (SpongeBob Battle for Bikini Bottom)](https://github.com/magcius/noclip.website/tree/main/src/HeavyIron) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser SpongeBob BFBB viewer.
* [noclip.website (SpongeBob The Movie)](https://github.com/magcius/noclip.website/tree/main/src/HeavyIron) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser SpongeBob The Movie viewer.
* [noclip.website (SpongeBob Revenge of the Flying Dutchman)](https://github.com/magcius/noclip.website/tree/main/src/SpongebobRevengeOfTheFlyingDutchman) ⭐ 4,240 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-10 - In-browser SpongeBob ROTFD viewer.
...
* [faxedit](https://github.com/kaimitai/faxedit) ⭐ 11 | 🐛 2 | 🌐 C++ | 📅 2026-08-16 - Echoes of Eolis: Faxanadu (NES) editing suite.
...
* [wolf3d](https://github.com/id-Software/wolf3d) ⭐ 2,520 | 🐛 1 | 📅 2012-02-06 - id Software's official 1995 open-source release of Wolfenstein 3D, including the original VSWAP/GAMEMAPS/AUDIOT-reading engine.
...
* [MacWolfSDL](https://github.com/kaylagator/MacWolfSDL) ⭐ 19 | 🐛 9 | 🌐 C | 📅 2025-08-18 - Accurate SDL3 source port of Macintosh Wolfenstein 3D, reading the original Mac resource-fork game data (including Third Encounter scenario compatibility).
...
* [SLADE](https://github.com/sirjuddington/SLADE) ⭐ 860 | 🐛 319 | 🌐 C++ | 📅 2026-08-07 - The comprehensive Doom-engine (id Tech 1) editor. Edit WAD/PK3/ZIP archives, maps, textures, graphics, sounds, and text lumps, with support for Doom, Heretic, Hexen, Strife, and other id Tech 1 games.

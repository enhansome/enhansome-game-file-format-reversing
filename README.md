...
* [awesome-gbdev](https://github.com/gbdev/awesome-gbdev) ⭐ 4,508 | 🐛 23 | 📅 2026-07-22 - Curated list of Game Boy development resources, including reverse-engineering tools, hardware/format documentation, disassemblers, and emulators.
...
* [Architecture of consoles](https://github.com/flipacholas/Architecture-of-consoles) ⭐ 1,104 | 🐛 27 | 📅 2026-09-12 - Series of technical articles on console hardware architecture, covering CPU, graphics, and file/memory layout across many platforms.
...
* [dsasmblr/game-hacking](https://github.com/dsasmblr/game-hacking) ⭐ 5,584 | 🐛 11 | 📅 2024-06-20 - Large curated collection of tutorials, tools, and resources for reverse engineering video games.
...
* [NitroPaint](https://github.com/Garhoogin/NitroPaint) ⭐ 110 | 🐛 3 | 🌐 C | 📅 2026-09-19 - Graphics editor for Nintendo DS image formats.
...
* [binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,356 | 🐛 94 | 🌐 Rust | 📅 2026-08-11 - Firmware analysis tool for identifying and extracting embedded files and data. The Rust version (v3) provides significant speed and accuracy improvements over the original Python version.
* [AssetRipper](https://github.com/AssetRipper/AssetRipper) ⭐ 8,379 | 🐛 159 | 🌐 C# | 📅 2026-09-17 - GUI tool for extracting assets from Unity serialized files (*CAB-*\\*, *\\*.assets*, etc.) and asset bundles (*\\*.unity3d\*, *\\*.bundle\*, etc.) and converting them into the native Unity engine format.
* [Universal Extractor 2](https://github.com/Bioruebe/UniExtract2) ⭐ 4,425 | 🐛 123 | 🌐 AutoIt | 📅 2024-07-06 - Generic tool to extract files from any type of archive or installer, commonly used to unpack game installers (NSIS, InstallShield, Wise, and many more) before further asset processing.
* [GARbro](https://github.com/morkt/GARbro) ⭐ 3,295 | 🐛 275 | 🌐 C# | 📅 2024-07-08 - Visual novels resource browser and extractor supporting many formats. See also [crskycode's fork](https://github.com/crskycode/GARbro) ⭐ 787 | 🐛 8 | 🌐 C# | 📅 2026-09-19, which is actively maintained with additional format support; [nanami5270's fork](https://github.com/nanami5270/GARbro-Mod) ⭐ 138 | 🐛 2 | 🌐 C# | 📅 2026-09-19, another actively maintained fork with additional format/game support; and [UserUnknownFactor's GARbro2](https://github.com/UserUnknownFactor/GARbro2) ⭐ 60 | 🐛 3 | 🌐 C# | 📅 2026-02-23, which adds ImageMagick-based format support, sprite-sheet animation, and an in-app playback mode.
...
* [OmniDrive](https://github.com/RibShark/OmniDrive) ⭐ 1,146 | 🐛 26 | 🌐 Assembly | 📅 2026-07-18 - Firmware modification for MediaTek MT1959-based Hitachi-LG optical disc drives, enabling raw sector and lead-in/lead-out reading of CD/DVD/BD media including proprietary game discs.
...
* [redumper](https://github.com/superg/redumper) ⭐ 509 | 🐛 102 | 🌐 C++ | 📅 2026-09-18 - Low-level CD dumper utility for bit-perfect optical disc preservation, used by the Redump.org preservation community.
...
* [dexvert](https://github.com/Sembiance/dexvert) ⭐ 171 | 🐛 1 | 🌐 Python | 📅 2026-09-19 - Identifies and converts over 3,700 file formats to modern equivalents, including many game-specific archive, texture, and model formats.
...
* [DiskImageTool](https://github.com/Digitoxin1/DiskImageTool) ⭐ 118 | 🐛 7 | 🌐 Visual Basic .NET | 📅 2026-09-19 - Floppy disk image manager with built-in bitstream analysis, Greaseweazle support, and optional Kryoflux integration.
...
* [LunaTranslator](https://github.com/HIllya51/LunaTranslator) ⭐ 13,276 | 🐛 43 | 🌐 C++ | 📅 2026-09-19 - Full-featured visual novel translator application combining game text extraction with translation, OCR, and TTS.
...
* [Textractor](https://github.com/Artikash/Textractor) ⭐ 2,691 | 🐛 635 | 🌐 C++ | 📅 2024-03-15 - Highly extensible universal text hooker/extractor for video games and visual novels, widely used as the base for translation and OCR pipelines.
* [GalTransl](https://github.com/GalTransl/GalTransl) ⭐ 2,271 | 🐛 37 | 🌐 Python | 📅 2026-09-18 - Automated translation pipeline for Japanese visual novels using LLMs (GPT-4, Claude, DeepSeek, Sakura), consuming the script/text JSON exported by engine-specific extraction tools (e.g. [msg-tool](https://github.com/lifegpc/msg-tool) ⭐ 57 | 🐛 3 | 🌐 Rust | 📅 2026-09-06) and re-inserting translated text. See also [GalTransl\_DumpInjector](https://github.com/GalTransl/GalTransl_DumpInjector) ⭐ 24 | 🐛 1 | 🌐 Python | 📅 2025-12-20, a companion GUI front-end wrapping VNTextPatch, msg-tool, or custom regex to dump/inject game text across many VN engines.
...
* [ImHex](https://github.com/WerWolv/ImHex) ⭐ 54,842 | 🐛 403 | 🌐 C++ | 📅 2026-09-18 - Modern, open-source hex editor with pattern language for reverse engineering file formats (free).
...
* [Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 79,101 | 🐛 1,963 | 🌐 Java | 📅 2026-09-18 - NSA's software reverse engineering (SRE) framework. Includes disassembly, assembly, decompilation, graphing, and scripting. Extensible through Java and Python plugins.
* [Cutter](https://github.com/rizinorg/cutter) ⭐ 19,746 | 🐛 494 | 🌐 C++ | 📅 2026-09-11 - Free and open-source GUI-based reverse engineering platform powered by Rizin, for analyzing game binaries and file formats.
...
* [Senbei](https://github.com/Momoko-Ayase/Senbei) ⭐ 69 | 🐛 1 | 🌐 Rust | 📅 2026-09-20 - Static unpacker for binaries protected by CrackProof DRM (used by games such as Street Fighter V and Umamusume: Pretty Derby), enabling further static analysis of the underlying executable.
...
* [bytecode-viewer](https://github.com/Konloch/bytecode-viewer) ⭐ 15,649 | 🐛 103 | 🌐 Java | 📅 2026-07-17 - A Java 8+ Jar & Android APK reverse engineering suite. Includes multiple decompilers (FernFlower, Procyon, CFR), bytecode assemblers, and a keyword search feature.
...
* [JPEXS Free Flash Decompiler](https://github.com/jindrapetrik/jpexs-decompiler) ⭐ 5,878 | 🐛 2 | 🌐 Java | 📅 2026-09-20 - Free Flash (SWF) decompiler/editor for viewing and modifying ActionScript 1/2/3 bytecode, shapes, sprites, sounds, and other tags in SWF files, widely used for reverse-engineering Flash-based games.
...
* [PS2Recomp](https://github.com/ran-j/PS2Recomp) ⭐ 3,271 | 🐛 94 | 🌐 C++ | 📅 2026-09-20 - Static recompiler and runtime that converts PlayStation 2 ELF binaries into C++ to produce native PC ports.
* [skate3recomp](https://github.com/mchughalex/skate3recomp) ⭐ 1,348 | 🐛 77 | 🌐 C++ | 📅 2026-07-24 - Native recompilation of the Xbox 360 version of Skate 3 for Windows, Linux, and macOS, with a native Direct3D 12/Vulkan renderer replacing GPU emulation.
* [rexglue-sdk](https://github.com/rexglue/rexglue-sdk) ⭐ 896 | 🐛 28 | 🌐 C | 📅 2026-09-15 - Xbox 360 recompilation runtime and toolkit, used by static recompilation PC ports of Xbox 360 games.
...
* [snesrecomp](https://github.com/RetroPortingToolKit/snesrecomp) ⭐ 95 | 🐛 5 | 🌐 C | 📅 2026-09-19 - Static recompiler ecosystem for SNES games (part of the R.A.I.D. community), converting 65816 ROM code into portable native code.
* [ndsrecomp](https://github.com/RetroPortingToolKit/ndsrecomp) ⭐ 42 | 🐛 1 | 🌐 C++ | 📅 2026-09-14 - Early-stage static recompiler for Nintendo DS games.
...
* [Dead\_Rising\_2\_Case\_West\_Xenon\_Recomp](https://github.com/wivi514/Dead_Rising_2_Case_West_Xenon_Recomp) ⭐ 40 | 🐛 0 | 🌐 C++ | 📅 2026-09-17 - Native PC port of the Xbox 360 XBLA game Dead Rising 2: Case West via static recompilation (Windows/Linux, Vulkan, keyboard/mouse and controller).
* [segagenesisrecomp](https://github.com/mstan/segagenesisrecomp) ⭐ 32 | 🐛 0 | 🌐 C | 📅 2026-09-20 - Static recompiler for Sega Genesis/Mega Drive games.
...
* [XEXLoaderWV](https://github.com/zeroKilo/XEXLoaderWV) ⭐ 176 | 🐛 7 | 🌐 Java | 📅 2026-08-01 - Ghidra loader module for Xbox 360 XEX executable files.
...
* [pcsx-redux](https://github.com/grumpycoders/pcsx-redux) ⭐ 994 | 🐛 161 | 🌐 C++ | 📅 2026-09-19 - Collection of tools, research, hardware design, and libraries for PlayStation 1 development and reverse engineering, built around a fork of the PCSX emulator with an integrated debugger, assembler, and GPU/memory analysis tooling.
...
* [diii4a](https://github.com/glKarin/com.n0n3m4.diii4a) ⭐ 608 | 🐛 168 | 🌐 C++ | 📅 2026-09-19 - Multi-engine Android/desktop port collection for idTech-derived games, reading each game's original assets.
...
* [XXMI Launcher](https://github.com/SpectrumQT/XXMI-Launcher) ⭐ 2,924 | 🐛 8 | 🌐 Python | 📅 2026-06-11 - Modding platform/launcher for a shared 3dmigoto-based model-importer ecosystem spanning multiple unrelated gacha titles, installing and hot-loading custom 3D character models as mods.
  * Components: [XXMI-Libs-Package](https://github.com/SpectrumQT/XXMI-Libs-Package) ⭐ 74 | 🐛 6 | 🌐 C++ | 📅 2026-09-19 (shared fork of [bo3b/3Dmigoto](https://github.com/bo3b/3Dmigoto) ⭐ 1,223 | 🐛 95 | 🌐 C++ | 📅 2026-09-06 packaged for the launcher), [XXMITools](https://github.com/leotorrez/XXMITools) ⭐ 144 | 🐛 58 | 🌐 Python | 📅 2026-09-15 (Blender add-on to import/export mod files for the supported games), [gui\_collect](https://github.com/Petrascyll/gui_collect) ⭐ 74 | 🐛 10 | 🌐 Python | 📅 2026-07-09 (GUI tool to collect/extract model data from 3dmigoto frame dumps for use with the importers).
  * Games: Genshin Impact (GIMI), Honkai: Star Rail (SRMI), Honkai Impact 3rd (HIMI), Zenless Zone Zero (ZZMI), Wuthering Waves (WWMI).
* [ScummVM](https://github.com/scummvm/scummvm) ⭐ 2,812 | 🐛 47 | 🌐 C++ | 📅 2026-09-19 - The canonical multi-engine interpreter that reimplements dozens of classic adventure/RPG engines, reading each game's original data files instead of emulating a CPU.
...
* [Zygisk-Il2CppDumper](https://github.com/Perfare/Zygisk-Il2CppDumper) ⭐ 3,294 | 🐛 173 | 🌐 C | 📅 2024-08-09 - Dumps IL2Cpp metadata from Unity games running on Android via Zygisk, enabling reverse-engineering of obfuscated game code and data.
* [Archipelago](https://github.com/ArchipelagoMW/Archipelago) ⭐ 1,671 | 🐛 615 | 🌐 Python | 📅 2026-09-12 - Multi-game item randomizer and server, generating patched ROMs/mods and syncing item checks across game worlds.
...
* [RomPatcher.js](https://github.com/marcrobledo/RomPatcher.js) ⭐ 1,205 | 🐛 19 | 🌐 JavaScript | 📅 2026-08-28 - JavaScript ROM patcher supporting IPS, BPS, UPS, APS, PPF, and other binary patch formats across many console ROM formats (used for Mario, Pokemon, Smash, and countless other ROM hacks).
...
* [BizHawk](https://github.com/TASEmulators/BizHawk) ⭐ 2,761 | 🐛 809 | 🌐 C# | 📅 2026-09-20 - Multi-system emulator built for tool-assisted speedrunning, with full rerecording, RAM search/watch, Lua scripting, and debugging tools across 20+ systems (NES, SNES, Genesis, Game Boy/GBA, N64, PS1, and more).
...
* [Hypdroid](https://github.com/rhakka303/Hypdroid) ⭐ 3 | 🐛 2 | 🌐 C | 📅 2026-09-11 - Standalone Android port of Hypseus Singe with a native gamepad-first game launcher.
...
* [Smithbox](https://github.com/vawser/Smithbox) ⭐ 724 | 🐛 2 | 🌐 C# | 📅 2026-09-20 - Comprehensive modding toolkit for modern FromSoftware games.
...
* [OpenE2140](https://github.com/OpenE2140/OpenE2140) ⭐ 71 | 🐛 100 | 🌐 C# | 📅 2026-09-19 - Playable remake of the RTS Earth 2140 built on the OpenRA engine (via the OpenRA Mod SDK), reading the original game's data files.
...
* [cinnamon](https://github.com/Project-Sunshine-Native/cinnamon) ⭐ 402 | 🐛 0 | 🌐 C | 📅 2026-09-14 - GameMaker runtime reimplementation ('Cinnamon') that loads original compiled GameMaker game data, in the tradition of phosphorvm and OpenGMK.
...
* [xash3d-fwgs](https://github.com/FWGS/xash3d-fwgs) ⭐ 2,790 | 🐛 430 | 🌐 C | 📅 2026-09-15 - Cross-platform reimplementation of the GoldSrc engine, loading original Half-Life BSP/WAD/MDL game data. Actively maintained; companion to hlsdk-portable.
* [ValveResourceFormat](https://github.com/ValveResourceFormat/ValveResourceFormat) ⭐ 2,435 | 🐛 64 | 🌐 C# | 📅 2026-09-19 - Source 2 Viewer is a powerful tool that allows you to browse VPK archives, view, extract, and decompile Source 2 assets, including maps, models, materials, textures, sounds, and more. Also includes C# library for reading and writing Valve Source engine resource files.
* [source-engine](https://github.com/nillerusr/source-engine) ⭐ 2,257 | 🐛 130 | 🌐 C++ | 📅 2025-11-25 - Modified Source engine (2017) developed by Valve and leaked in 2020. Not for commercial purposes.
...
* [awpy](https://github.com/pnxenopoulos/awpy) ⭐ 613 | 🐛 30 | 🌐 Python | 📅 2026-09-10 - Python library for parsing and analyzing Counter-Strike 2 .dem demo files (via a Rust demoparser backend) and CS2 .nav navigation-mesh files, exposing tick-level player/event data as dataframes.
...
* [hlsdk-portable](https://github.com/FWGS/hlsdk-portable) ⭐ 406 | 🐛 45 | 🌐 C++ | 📅 2026-09-19 - Cross-platform, actively maintained continuation of the Half-Life SDK for GoldSource and Xash3D, used to build original HL1 mod DLLs on modern OSes.
...
* [MetaHookSv](https://github.com/hzqst/MetaHookSv) ⭐ 253 | 🐛 38 | 🌐 C++ | 📅 2026-09-20 - Port of MetaHook to SvEngine (GoldSrc as modified by the Sven Co-op team), a client-side modding framework for Sven Co-op and other GoldSrc-based games.
...
* [gchimp](https://github.com/khanghugo/gchimp) ⭐ 31 | 🐛 19 | 🌐 Rust | 📅 2026-09-06 - Collection of GoldSrc mapping tools in one GUI/CLI application.
...
* [WifeRadiant](https://github.com/erysdren/WifeRadiant) ⭐ 123 | 🐛 15 | 🌐 C++ | 📅 2026-09-19 - Open-source, cross-platform level editor for idTech, Source Engine, and GoldSrc based games; modern fork of NetRadiant.
...
* [VPKEdit](https://github.com/craftablescience/VPKEdit) ⭐ 746 | 🐛 50 | 🌐 C++ | 📅 2026-09-15 - Cross-platform GUI and CLI tool for creating, reading, and writing many pack file formats used across Source, GoldSrc, and Quake-family games.
...
* [Blender Source Tools](https://github.com/Artfunkel/BlenderSourceTools) ⭐ 290 | 🐛 5 | 🌐 Python | 📅 2025-11-01 - Blender addon for importing and exporting Source Engine model and animation formats. Enables 3D asset creation and modification for all Source Engine games in Blender.
...
* [dota2-mod-manager](https://github.com/TheFleece/dota2-mod-manager) ⭐ 33 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-20 - Mod manager for Dota 2, working with the game's original VPK addon format.
...
* [UABEA (Unity Asset Bundle Extractor Avalonia)](https://github.com/nesrak1/UABEA) ⭐ 2,432 | 🐛 146 | 🌐 C# | 📅 2026-05-11 - C# UABE for newer versions of Unity. Cross-platform Unity asset bundle and serialized file editor/extractor built with Avalonia.
...
* [AnimeStudio](https://github.com/Escartem/AnimeStudio) ⭐ 1,190 | 🐛 28 | 🌐 C++ | 📅 2026-09-03 - Actively maintained "modded AssetStudio" fork with support for many encrypted Unity titles, including all HoYoverse games.
...
* [frida-il2cpp-bridge](https://github.com/vfsfitvnm/frida-il2cpp-bridge) ⭐ 1,745 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-06 - TypeScript Frida module/library for dumping, tracing, or hijacking any IL2CPP application at runtime without needing the `global-metadata.dat` file; widely used as the base library for other Frida-based IL2CPP tooling, including frida-il2cpp-proto-dumper above.
...
* [Zygisk-Il2CppFucker](https://github.com/Darlenepurpleblack444/Zygisk-Il2CppFucker) ⭐ 4 | 🐛 0 | 🌐 C | 📅 2026-09-20 - Zygisk module for reverse engineering IL2CPP binaries in Android Unity games at runtime.
...
* [BepInEx](https://github.com/BepInEx/BepInEx) ⭐ 8,678 | 🐛 386 | 🌐 C# | 📅 2026-09-01 - Widely-used, general-purpose plugin/patcher framework for Unity (Mono and IL2CPP) and .NET games, providing runtime hooking and mod-loading infrastructure used by many game-specific modding tools.
* [XUnity.AutoTranslator](https://github.com/bbepis/XUnity.AutoTranslator) ⭐ 3,418 | 🐛 450 | 🌐 C# | 📅 2026-09-10 - Universal translation framework for Unity games. Supports automatic text translation with various translator backends and IL2CPP support.
...
* [UnityDoorstop](https://github.com/NeighTools/UnityDoorstop) ⭐ 594 | 🐛 26 | 🌐 C | 📅 2026-09-01 - Cross-platform native bootstrapper that loads a .NET assembly into any Unity game at startup, used as the entry point by BepInEx and other Unity mod loaders.
...
* [CUE4Parse](https://github.com/FabianFG/CUE4Parse) ⭐ 640 | 🐛 28 | 🌐 C# | 📅 2026-09-19 - C# Parser for UE archives.
* [UAssetAPI](https://github.com/atenfyr/UAssetAPI) ⭐ 495 | 🐛 6 | 🌐 C# | 📅 2026-08-31 - Low-level .NET library for reading and writing Unreal Engine game assets.
...
* [UEFormat](https://github.com/h4lfheart/UEFormat) ⭐ 347 | 🐛 2 | 🌐 Python | 📅 2026-08-14 - Library for working with Unreal Engine file formats.
...
* [AssetTools](https://github.com/PedroMartinsMenezes/AssetTools) ⭐ 26 | 🐛 1 | 🌐 C# | 📅 2026-09-20 - Converts UE .uasset and .umap files to JSON and back, supporting UE5 asset formats.
...
* [FModel](https://github.com/4sval/FModel) ⭐ 3,159 | 🐛 12 | 🌐 C# | 📅 2026-09-19 - Explorer and asset viewer for Unreal Engine archives, supporting UE4 and UE5.
...
* [UEViewer (UModel)](https://github.com/gildor2/UEViewer) ⭐ 2,929 | 🐛 25 | 🌐 C++ | 📅 2024-03-16 - Viewer and exporter for Unreal Engine 1-4 assets (UE Viewer).
...
* [UEVR](https://github.com/praydog/UEVR) ⭐ 4,524 | 🐛 218 | 🌐 C++ | 📅 2026-08-30 - Universal Unreal Engine VR Mod. Powerful runtime reversing tool that provides an overlay for inspecting objects, classes, and properties in almost any UE4/5 game.
* [Dumper-7](https://github.com/Encryqed/Dumper-7) ⭐ 2,266 | 🐛 36 | 🌐 C | 📅 2026-09-15 - Unreal Engine SDK generator supporting all UE4 and UE5 versions, dumping engine classes/structs/offsets from a running game via DLL injection; the de facto standard modern UE SDK dumper and basis for several other tools already listed (e.g. UETools-GUI).
* [UEDumper](https://github.com/Spuckwaffel/UEDumper) ⭐ 1,402 | 🐛 1 | 🌐 C++ | 📅 2026-04-18 - UE 4.19-5.3 reverse engineering tool for dumping SDK, analyzing structures, and identifying memory offsets.
...
* [RE-UE4SS](https://github.com/UE4SS-RE/RE-UE4SS) ⭐ 2,915 | 🐛 273 | 🌐 C++ | 📅 2026-09-20 - Lua scripting system, SDK generator, blueprint mod loader, and live property editor for UE4/5 games. See also [UE4SSDotNet](https://github.com/WistfulHopes/UE4SSDotNet) ⭐ 2 | 🐛 1 | 🌐 C# | 📅 2025-07-26 for a UnrealCLR-based .NET runtime companion.
...
* [Dagor Engine](https://github.com/GaijinEntertainment/DagorEngine) ⭐ 2,963 | 🐛 76 | 🌐 C++ | 📅 2026-09-20 - Open-source release of the Dagor Engine (War Thunder, Enlisted) including parts of the toolchain.
...
* [EasyRPG Player](https://github.com/EasyRPG/Player) ⭐ 1,225 | 🐛 437 | 🌐 C++ | 📅 2026-09-10 - Open-source interpreter that runs RPG Maker 2000/2003 games natively, reading their LCF data formats (LMU maps, LDB/LMT databases) via liblcf.
...
* [mkxp](https://github.com/Ancurio/mkxp) ⭐ 588 | 🐛 45 | 🌐 C++ | 📅 2026-01-18 - Open-source reimplementation of the Ruby Game Scripting System (RGSS) used by RPG Maker XP, VX, and VX Ace, running games natively by reading their RGSSAD/RGSS2A/RGSS3A archives. See also the more actively maintained [mkxp-z fork](https://github.com/mkxp-z/mkxp-z) ⭐ 378 | 🐛 157 | 🌐 C++ | 📅 2026-06-30.
...
* [rpgmtranslate-qt](https://github.com/RPG-Maker-Translation-Tools/rpgmtranslate-qt) ⭐ 25 | 🐛 2 | 🌐 C++ | 📅 2026-09-16 - Fast Qt-based GUI for editing and translating RPG Maker games. Successor to the same org's now-abandoned [rpgmtranslate](https://github.com/RPG-Maker-Translation-Tools/rpgmtranslate) ⭐ 30 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-02.
...
* [rpycdec](https://github.com/cnfatal/rpycdec) ⭐ 58 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - Actively maintained tool for decompiling Ren'Py compiled script files.
...
* [OnscripterYuri](https://github.com/YuriSizuku/OnscripterYuri) ⭐ 852 | 🐛 18 | 🌐 C++ | 📅 2026-06-23 - Enhanced ONScripter engine port, running original ONScripter/NScripter game data across many platforms, with a focus on web (Emscripten/WASM).
...
* [rfvp](https://github.com/xmoezzz/rfvp) ⭐ 138 | 🐛 2 | 🌐 Rust | 📅 2026-09-19 - Non-official Rust reimplementation of the FVP engine and IDE, running games directly from their original `.hcb` script/asset files, with a debug HUD, custom-font support, and UTF-8/GBK translated-text encoding switching.
...
* [siglus\_rs](https://github.com/xmoezzz/siglus_rs) ⭐ 84 | 🐛 5 | 🌐 Rust | 📅 2026-09-20 - Unofficial Rust reimplementation and multi-platform port of SiglusEngine (Windows, Linux, macOS, iOS, Android, WebAssembly), for research purposes.
...
* [SiglusSceneScriptUtility](https://github.com/Jirehlov/SiglusSceneScriptUtility) ⭐ 22 | 🐛 0 | 🌐 Python | 📅 2026-09-20 - Extracts Siglus `Scene.pck` archives to editable `.ss` SceneScript files and recompiles them, aiming to reproduce the engine's original compilation as exactly as possible.
...
* [Inform 7](https://github.com/ganelson/inform) ⭐ 1,644 | 🐛 9 | 🌐 C | 📅 2026-06-24 - Core distribution of the Inform 7 natural-language interactive fiction authoring system, compiling through Inform 6 to Z-code or Glulx bytecode.
...
* [Ruffle](https://github.com/ruffle-rs/ruffle) ⭐ 18,556 | 🐛 5,636 | 🌐 Rust | 📅 2026-09-20 - Flash Player emulator written in Rust that parses and executes SWF files and ActionScript bytecode, used to preserve and play thousands of Flash-based web games.
...
* [gdsdecomp](https://github.com/GDRETools/gdsdecomp) ⭐ 4,210 | 🐛 40 | 🌐 C++ | 📅 2026-08-16 - Godot reverse engineering toolkit for game file format recovery, GDScript bytecode decompilation, and PCK archive extraction (Godot 2.x, 3.x, 4.x).
...
* [RT64](https://github.com/rt64/rt64) ⭐ 1,595 | 🐛 91 | 🌐 C++ | 📅 2026-09-16 - N64 graphics renderer implementing the RDP/F3D microcode family with enhancements (widescreen, higher resolutions, ray tracing) for emulators and native ports.
...
* [aurora](https://github.com/encounter/aurora) ⭐ 521 | 🐛 11 | 🌐 C++ | 📅 2026-09-19 - Source-level GameCube & Wii GX graphics compatibility layer, used by decompilation and static-recompilation projects to run original GC/Wii rendering code on modern backends (Dawn/WebGPU).
...
*[Murder Engine](https://github.com/isadorasophia/murder) ⭐ 3,326 | 🐛 16 | 🌐 C# | 📅 2026-09-20, a 2D game engine/framework used by several indie titles.*
...
* [MMD Tools Append](https://github.com/MMD-Blender/blender_mmd_tools_append) ⭐ 650 | 🐛 20 | 🌐 Python | 📅 2026-09-16 - Companion extension for MMD Tools that provides material/scene controls, lighting presets, and Rigify helpers.
